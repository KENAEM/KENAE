...
if (text == "قفل التاك") then
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل التاك")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الشارحه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل التعديل")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل التكرار")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل المتحركه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الملفات")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الماركدون")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الصور")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الملصقات")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الفيديو")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الانلاين")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الدردشه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل التوجيه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل التثبيت")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الاغاني")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الصوت")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الجهات")
  else
  ...
  if tsX_o then
    tsX000("lock",msg,"☑┇بالتأكيدتم قفل العربيه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الانكليزيه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الميديا")
  else
...
database:set("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  if tsX_o then
    tsX000("lock",msg,"☑┇بالتأكيدتم قفل الروابط")
  else
  ...
  if tsX_o then
   tsX000("lock",msg,"☑┇بالتأكيدتم قفل المعرف")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل الاشعارات")
  else
  ...
  if tsX_o then
   tsX000("lock",msg,"☑┇بالتأكيدتم قفل البوتات بالطرد")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل البوتات")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم قفل بصمه فيديو")
  else
  ...
  local tsX_o = database:get("lock_new:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"☑┇بالتأكيدتم فتح الاشعارات")
  else
  ...
  local tsX_o = database:get("lock_tag:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح التاك")
  else
  ...
  local tsX_o = database:get("lock_sarha:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الشارحه")
  else
  ...
  local tsX_o = database:get("lock_lllll:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح التكرار")
  else
  ...
  local tsX_o = database:get("lock_edit:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح التعديل")
  else
  ...
  local tsX_o = database:get("lock_gif:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"☑┇بالتأكيدتم فتح المتحركه")
  else
  ...
  local tsX_o = database:get("lock_files:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الملفات")
  else
  ...
  local tsX_o = database:get("lock_mark:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الماركدون")
  else
  ...
  local tsX_o = database:get("lock_photo:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الصور")
  else
  ...
  local tsX_o = database:get("lock_stecker:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الملصقات")
  else
  ...
  local tsX_o = database:get("lock_video:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الفيديو")
  else
  ...
  local tsX_o = database:get("lock_inline:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الانلاين")
  else
  ...
  local tsX_o = database:get("lock_chat:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الدردشه")
  else
  ...
  local tsX_o = database:get("lock_fwd:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح التوجيه")
  else
  ...
  local tsX_o = database:get("lock_pin:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح التثبيت")
  else
  ...
  local tsX_o = database:get("lock_audeo:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الاغاني")
  else
  ...
  local tsX_o = database:get("lock_voice:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الصوت")
  else
  ...
  local tsX_o = database:get("lock_botAndBan:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح البوتات بالطرد")
  else
  ...
  local tsX_o = database:get("lock_contact:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الجهات")
  else
  ...
  local tsX_o = database:get("lock_ar:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح العربيه")
  else
  ...
  local tsX_o = database:get("lock_en:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الانكليزيه")
  else
  ...
  local tsX_o = database:get("lock_media:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الميديا")
  else
...
database:del("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  local tsX_o = database:get("lock_username:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح المعرف")
  else
  ...
  local tsX_o = database:get("lock_note:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح بصمه فيديو")
  else
  ...
  local tsX_o = database:get("lock_link:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيدتم فتح الروابط")
  else
  ...
  local tsX_o = database:get("lock_bot:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"☑┇بالتأكيدتم فتح البوتات")
  else
