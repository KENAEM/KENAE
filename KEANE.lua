...
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. v .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
  ...
  send(msg.chat_id_, msg.id_, 1, '👁‍🗨 ⫶ بالتأكيد تم الاعظاء ⌁ المقيدين ✓', 1, 'md')
  end  
...
database:del('KENAE:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم المحظورين  من البوت ', 1, 'md')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم قائمه المنشئين', 1, 'md')
  end
  ...
  bot.channel_get_bots(msg.chat_id_,cb)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم جميع البوتات', 1, 'md')
  end
  if txt[2] == 'الادمنيه' and is_owner(msg) then
  database:del('KENAE:'..bot_id..'mods:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم قائمه الادمنيه', 1, 'md')
  end
  if  txt[2] == 'الاعضاء المميزين' and is_owner(msg) then
  database:del('KENAE:'..bot_id..'vipgp:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم قائمه الاعضاء المميزين', 1, 'md')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم قائمه المدراء', 1, 'md')
  end
  if  txt[2] == 'القوانين' then
  database:del('KENAE:'..bot_id..'rules'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم القوانين المحفوظه', 1, 'md')
  end
  if txt[2] == 'الرابط' then
  database:del('KENAE:'..bot_id..'group:link'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم الرابط المحفوظ', 1, 'md')
  end
  if txt[2] == 'قائمه المنع' then
  database:del('KENAE:'..bot_id..'filters:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم قائمه المنع', 1, 'md')
  end
  if  txt[2] == 'المكتومين' then
  database:del('KENAE:'..bot_id..'muted:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم قائمه المكتومين', 1, 'md')
  end
  end
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
 ...
 redis:srem('KENAE:'..bot_id..'kalire'..msg.chat_id_..'', text)
  ...
  redis:del('KENAE:'..bot_id..'sudoo'..v..'', 'no')
    ...
    send(msg.chat_id_, msg.id_, 1, "☑┇بالتأكيد تم مطورين البوت", 1, 'md')
    end
  ...
  redis:set('KENAE:'..bot_id..'kali'..v..''..msg.chat_id_..'', " ")
    ...
    send(msg.chat_id_, msg.id_, 1, "• `بالتأكيد تم ردود المدير` 🗑", 1, 'md')
    end
  ...
  redis:set('KENAE:'..bot_id..'kali'..v..'', " ")
    ...
    send(msg.chat_id_, msg.id_, 1, "☑┇بالتأكيد تم ردود المطور", 1, 'md')
    end
  ...
  text = "❕┇لا يوجد ردود للمدير"
    ...
    changetitle(msg.chat_id_, txt[2])
     send(msg.chat_id_, msg.id_, 1, '✔┇بالتأكيد تم اسم المجموعه الى \n'..txt[2], 1, 'md')
  end
  ...
  https.request('https://api.telegram.org/bot'..token..'/deleteChatPhoto?chat_id='..msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '🗑┇بالتأكيد تم الصوره', 1, 'md')
  end
...
if  (text and text == 'تفعيل ردود البوت') and is_owner(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇ بالتأكيد تم مجموعه المطور', 1, 'md')
