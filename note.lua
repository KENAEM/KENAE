...
local function keko_keane(data)
...
local var = false
local mod = database:sismember('keane:'..bot_id..'mods:'..chat_id, user_id)
local admin = database:sismember('keane:'..bot_id..'admins:', user_id)
local owner = database:sismember('keane:'..bot_id..'owners:'..chat_id, user_id)
local creator = database:sismember('keane:'..bot_id..'creator:'..chat_id, user_id)
...
local owner = database:sismember('keane:'..bot_id..'owners:'..chat_id, user_id)
local creator = database:sismember('keane:'..bot_id..'creator:'..chat_id, user_id)
local vip = database:sismember('keane:'..bot_id..'vipgp:'..chat_id, user_id)
if mod then var = true end
if owner then var = true end
if creator then var = true end
if admin then var = true end
...
if user_id == v then
var = true end end
local keko_add_sudo = redis:get('keane:'..bot_id..'sudoo'..user_id..'')
if keko_add_sudo then var = true end
return var end
...
if database:get("lock_link.note:keane"..msg.chat_id_..bot_id) then
...
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
end
end
...
if database:get("lock_username.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_chat.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if text and text:match("(.*)(/)(.*)")  then
if database:get("lock_sarha.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if text and text:match("(.*)(#)(.*)")  then
if database:get("lock_tag.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_fwd.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_stecker.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_note.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_photo.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_audeo.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_voice.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_video.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_gif.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_contect.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false")
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_ar.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_files.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_en.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
...
if database:get("lock_mark.note:keane"..msg.chat_id_..bot_id) then
delete_msg(msg.chat_id_,{[0] = msg.id_})
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. msg.sender_user_id_ .. "&can_send_messages=false&can_send_media_messages=false&can_send_other_messages=false&can_add_web_page_previews=false") 
database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, msg.sender_user_id_)
end
 ...
 if text then 
  ...
  local hash =   'keane:'..bot_id..'res:'..msg.chat_id_
...
info = '💬┇بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'keaneteam')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
 end
getUser(msg.sender_user_id_, keko333)
end
if value == "prore" then
function get_keaneX(tshakex1,keanex2,tshakex3)
local id_keanex = keanex2.sender_user_id_
function keko333(extra,result,success)
info = '👤┇العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'keaneteam')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
 end
getUser(id_keanex, keko333)
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,get_keaneX)
end
if value ~= "prore" and value~= "lock"  then
function keko333(extra,result,success)
info = '👤┇العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'keaneteam')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
if ck_mod(result.sender_user_id_, msg.chat_id_) then
  ...
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, result.id_)
  texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(res[2] or 'keaneteam')..')\n☑️┇تم تقييده'
  end
  else
  texts = '✖️┇خطاء'
  end
  ...
  database:sadd('keane:'..bot_id..'res:'..msg.chat_id_, res[2])
...
if (text == "قفل التاك بالتقيد") then
  local tsX_o = database:get("lock_tag.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل التاك بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل التاك بالتقييد")
  database:set("lock_tag.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الشارحه بالتقيد") then
  local tsX_o = database:get("lock_sarha.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الشارحه بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الشارحه بالتقييد")
  database:set("lock_sarha.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل المتحركه بالتقيد") then
  local tsX_o = database:get("lock_gif.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل المتحركه بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل المتحركه بالتقييد")
  database:set("lock_gif.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الملفات بالتقيد") then
  local tsX_o = database:get("lock_files.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الملفات بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الملفات بالتقييد")
  database:set("lock_files.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الماركدون بالتقيد") then
  local tsX_o = database:get("lock_mark.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الماكدون بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الماركدون بالتقييد")
  database:set("lock_mark.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الصور بالتقيد") then
  local tsX_o = database:get("lock_photo.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الصور بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الصور بالتقييد")
  database:set("lock_photo.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الملصقات بالتقيد") then
  local tsX_o = database:get("lock_stecker.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الملصقات بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الملصقات بالتقييد")
  database:set("lock_stecker.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الفيديو بالتقيد") then
  local tsX_o = database:get("lock_video.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الفيديو بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الفيديو بالتقييد")
  database:set("lock_video.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الانلاين بالتقيد") then
  local tsX_o = database:get("lock_inline.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الانلاين بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الانلاين بالتقييد")
  database:set("lock_inline.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الدردشه بالتقيد") then
  local tsX_o = database:get("lock_chat.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الدردشه بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الدردشه بالتقييد")
  database:set("lock_chat.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل التوجيه بالتقيد") then
  local tsX_o = database:get("lock_fwd.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل التوجيه بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل التوجيه بالتقييد")
  database:set("lock_fwd.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الاغاني بالتقيد") then
  local tsX_o = database:get("lock_audeo.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الاغاني بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الاغاني بالتقييد")
  database:set("lock_audeo.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الصوت بالتقيد") then
  local tsX_o = database:get("lock_voice.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الصوت بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الصوت بالتقييد")
  database:set("lock_voice.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الجهات بالتقيد") then
  local tsX_o = database:get("lock_contact.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الجهات بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الجهات بالتقييد")
  database:set("lock_contact.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل العربيه بالتقيد") then
  local tsX_o = database:get("lock_ar.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
    tsX000("lock",msg,"☑️┇بالفعل تم قفل العربيه بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل العربيه بالتقييد")
  database:set("lock_ar.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الانكليزيه بالتقيد") then
  local tsX_o = database:get("lock_en.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل الانكليزيه بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الانكليزيه بالتقييد")
  database:set("lock_en.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل الروابط بالتقيد") then
  local tsX_o = database:get("lock_link.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
    tsX000("lock",msg,"☑️┇بالفعل تم قفل الروابط بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل الروابط بالتقييد")
  database:set("lock_link.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل المعرف بالتقيد") then
  local tsX_o = database:get("lock_username.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
   tsX000("lock",msg,"☑️┇بالفعل تم قفل المعرف بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل المعرف بالتقييد")
  database:set("lock_username.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  if (text == "قفل بصمه الفيديو بالتقيد") then
  local tsX_o = database:get("lock_note.note:keane"..msg.chat_id_..bot_id)
  if tsX_o then
  tsX000("lock",msg,"☑️┇بالفعل تم قفل بصمه الفيديو بالتقييد")
  else
  tsX000("lock",msg,"☑️┇تم قفل بصمه الفيديو بالتقييد")
  database:set("lock_note.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
end
if is_mod(msg) then
  ...
  database:del("lock_tag.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_sarha.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_gif.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_files.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_mark.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_photo.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_stecker.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_video.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_inline.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_chat.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_fwd.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_audeo.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_voice.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_contact.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_ar.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_en.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_username.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_note.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  ...
  database:del("lock_link.note:keane"..msg.chat_id_..bot_id,"ok")
  end
  end
  end
       ...
       ------------
       if database:get("lock_inline.note:keane"..msg.chat_id_..bot_id) then
       mute_in = '✔┇'
       else
       mute_in = '✖┇'
       end
  ...
  if database:get("lock_sarha.note:keane"..msg.chat_id_..bot_id) then
   ...
   if database:get("lock_username.note:keane"..msg.chat_id_..bot_id) then
       ...
       ------------
  if database:get("lock_contact.note:keane"..msg.chat_id_..bot_id) then
       lock_contact = '✔┇'
       else
       lock_contact = '✖┇'
       end
...
local ex = database:ttl( 'keane:'..bot_id.."charge:"..msg.chat_id_)
  if ex == -1 then
  exp_dat = 'لا نهائي'
  else
  ...
  redis:set('keane:'..bot_id..'hres1'..msg.sender_user_id_..'', 'msg')
    return false end
  local keko2 = redis:get('keane:'..bot_id..'hres1'..msg.sender_user_id_..'')
  if keko2 == 'msg' then
  if text:match("^(.*)$") then
  send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
  redis:set('keane:'..bot_id..'hres1'..msg.sender_user_id_..'', 'no')
  redis:set('keane:'..bot_id..'hres', text)
