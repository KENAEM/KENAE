...
h = http.request("http://api-victor.ml/keko/ads.php?get=KENAE")
...
{
{text = ''..(channel_ts or "KENAE TEAM")..'', url=''..(channel_user_ts or 't.me/KENAE')..''},
},
}
...
info = '💬┇بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAE')..')\n'..text
...
info = '👤┇العضو ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAE')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
info = '👤┇العضو ~⪼ ['..(result.first_name_ or value)..'](t.me/'..(result.username_ or 'KENAE')..')\n'..text
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
local keko222 = 'https://KENAE.tk/KENAEApi/ch.php?id='..msg.sender_user_id_..''
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'KENAE')..')\n☑┇تم رفع منشئ في البوت'
else
texts = '✖┇خطاء'
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'KENAE')..')\n☑┇تم رفعه ادمن'
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apba[2] or 'KENAE')..')\n☑┇تم حظره من المجموعه'
...
local hash =  'KENAE:'..bot_id..'gbanned:'
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apbll[2] or 'KENAE')..')\n🚫┇تم حظره من المجموعات البوت'
...
local hash =  'KENAE:'..bot_id..'gbanned:'
if result.id_ then
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apid[2] or 'KENAE')..')\n🚫┇تم الغاء حظره من المجموعات البوت'
database:srem(hash, result.id_)
else
texts = '✖┇خطاء'
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apsi[2] or 'KENAE')..')\n🚫┇تم كتمه من البوت'
end
else
texts = '✖┇خطاء'
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apki[2] or 'KENAE')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9647723177600), (nakeko or "KENAE TEAM"), "", bot_id)
end
end
for k,v in pairs(sudo_users) do
...
getUser(msg.sender_user_id_, keko_KENAE_re)
...
redis:del('KENAE:'..bot_id..'keko'..text..''..msg.chat_id_..'')
...
redis:del('KENAE:'..bot_id..'keko'..text)
...
redis:del('KENAE:'..bot_id..'keko'..v..''..msg.chat_id_)
...
database:del("KENAE:all_if:"..tsha_text..bot_id..msg.chat_id_)
...
info = '👤┇العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'KENAE')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
