...
if (text == "قفل التاك") then
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل التاك")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الشارحه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل التعديل")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل التكرار")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل المتحركه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الملفات")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الماركدون")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الصور")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الملصقات")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الفيديو")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الانلاين")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الدردشه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل التوجيه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل التثبيت")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الاغاني")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الصوت")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الجهات")
  else
  ...
  if tsX_o then
    tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل العربيه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الانكليزيه")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الميديا")
  else
...
database:set("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  if tsX_o then
    tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الروابط")
  else
  ...
  if tsX_o then
   tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل المعرف")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل الاشعارات")
  else
  ...
  if tsX_o then
   tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل البوتات بالطرد")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل البوتات")
  else
  ...
  if tsX_o then
  tsX000("lock",msg,"☑┇بالفعل بالتأكيد تم قفل بصمه فيديو")
  else
...
tsX000("prore",msg,"☑┇بالفعل بالتأكيد تم رفع منشئ في البوت")
else
...
tsX000(apsi[2],msg,"🚫┇تم كتمه من البوت")
  ...
  send(msg.chat_id_, msg.id_, 1, '✖┇لا تستطيع طرد \n🔘┇(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
    ...
    if database:sismember(hash, result.sender_user_id_) then
	tsX000("prore",msg,"☑┇بالفعل بالتأكيد تم رفع مدير في البوت")
    else
     database:sadd(hash, result.sender_user_id_)
...
send(msg.chat_id_, 0, 1, '⚠️┇تم كشف عمليه تخريب في المجموعة \n‼️┇بالتأكيد تم قفل الميديا وسيتم طرد جميع الاشخاص الذين يقومون بعمل تكرار', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '🎫┇الايدي ~⪼*('..msg.sender_user_id_..')* \n❕┇قمت بعمل تكرار للرسائل المحدده\n☑┇تم كتمك في المجموعه\n', 1, 'md')
end 
if (o and (tonumber(o) > 5)) then
...
gpss = database:smembers( 'KENAE:'..bot_id.."groups") or 0
send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم نشر الرساله في {'..(#gpss - pro)..'} مجموعه ', 1, 'md')
end
end
local keko1 = redis:get('KENAE:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
if keko1 == 're' then
