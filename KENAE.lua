...
local i8_88 = io.popen('cd files_KEANE && ls'):read("*all")
local files_KEANE2 = ''
...
send(msg.chat_id_, msg.id_, 1, "🔘┇ بالتأكيد تم تعين : "..i8_88j[2], 1, 'html')
end
end
end
...
local i8_88 = { -- the List By : KENAETEAM
        'عير',
        'كس',
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
  ...
  local nai8_88 = redis:get('KENAE:'..bot_id..'nai8_88')
   ...
   sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (ni8_88 or 9647819831695), (nai8_88 or "KENAE"), "", bot_id)
  end
   end
    for k,v in pairs(sudo_users) do
...
💎┇م5 ~⪼ لعرض اوامر التقييد		
 ...
 send(msg.chat_id_, msg.id_, 1, (help or text), 1, 'md')
  ...
  redis:set('KENAE:'..bot_id..'h11'..msg.sender_user_id_..'', 'msg')
    return false end
  if text:match("^(.*)$") then
  local i8_882 = redis:get('KENAE:'..bot_id..'h11'..msg.sender_user_id_..'')
  if i8_882 == 'msg' then
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
➖➖➖➖➖➖➖➖
  ...
  if (text and text == 'تغير امر م2') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   redis:set('KENAE:'..bot_id..'h22'..msg.sender_user_id_..'', 'msg')
     return false end
   if text:match("^(.*)$") then
   local i8_882 = redis:get('KENAE:'..bot_id..'h22'..msg.sender_user_id_..'')
   if i8_882 == 'msg' then
   send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
 ...
 📡┇Ch ~⪼ @KENAETEAM ]]                                        
  ...
  if (text and text == 'تغير امر م4') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   redis:set('KENAE:'..bot_id..'h44'..msg.sender_user_id_..'', 'msg')
     return false end
   if text:match("^(.*)$") then
   local i8_882 = redis:get('KENAE:'..bot_id..'h44'..msg.sender_user_id_..'')
   if i8_882 == 'msg' then
   send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
➖➖➖➖➖➖➖➖]]
  ...
  return false end
    if text:match("^(.*)$") then
    local i8_882 = redis:get('KENAE:'..bot_id..'h55'..msg.sender_user_id_..'')
    if i8_882 == 'msg' then
    send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
