...
local function send(chat_id, reply_to_message_id, disable_notification, text, disable_web_page_preview, parse_mode)
  ...
  {
  {text = ''..(channel_ts or "kaliE TEAM")..'', url=''..(channel_user_ts or 't.me/kaliETEAM')..''},
  },
  }
...
os.execute('cd libs && wget https://raw.githubusercontent.com/kaliETEAM/kaliE/master/libs/utils.lua')
os.execute('rm -rf kaliE.lua')
os.execute('wget https://raw.githubusercontent.com/kaliETEAM/kaliE/master/kaliE.lua')
os.exit()
return false
end
...
tsX000("prore",msg,"☑┇بالفعل تم رفعه عضو مميز") 
  ...
  database:set("tsahke:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_,'kaliE')
  return "kaliE"
  end
...
local ex = database:ttl( 'kaliE:'..bot_id.."charge:"..msg.chat_id_)
  ...
  local nakali = redis:get('kaliE:'..bot_id..'nakali')
    ...
    sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkali or 9647707641864), (nakali or "kaliE TEAM"), "", bot_id)
  end
   end
    for k,v in pairs(sudo_users) do
