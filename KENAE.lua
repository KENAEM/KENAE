...
database:set( 'KENAE:'..bot_id.."enable:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_, 1, '🔘┇بالتاكيد تم وضع وقت انتهاء البوت *{'..a[2]..'}* يوم', 1, 'md')
end--
...
send(msg.chat_id_, msg.id_, 1, '✔┇بالتاكيد تم وضع صوره للمجموعه', 1, 'md')
...
function res_by_username(extra, result, success)
 ...
 local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
  if not database:sismember(hash, result.sender_user_id_) then
    tsX000("prore",msg,"👁‍🗨 ⫶ بالتاكيد تم الغاء تقيد ⌁ العضو ✓")
  else
  ...
  if database:sismember(hash, result.sender_user_id_) then
  tsX000("prore",msg,'☑┇بالتأكيد بالتاكيد تم رفعه ادمن')
  else
  database:sadd(hash, result.sender_user_id_)
  tsX000("prore",msg,'☑┇بالتاكيد تم رفعه ادمن')
  end
  end
  ...
  tsX000(apmd[2],msg,"☑┇بالتاكيد تم رفعه ادمن")
  end
  ...
  if database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"☑┇بالتأكيد بالتاكيد تم رفعه عضو مميز") 
 else
  database:sadd(hash, result.sender_user_id_)
   tsX000("prore",msg,"☑┇بالتاكيد تم رفعه عضو مميز")
 end
  end
  getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
  end
  ...
  database:sadd('KENAE:'..bot_id..'vipgp:'..msg.chat_id_, apmd[2])
	tsX000(apmd[2],msg,"☑┇بالتاكيد تم رفعه عضو مميز")
  end
 ...
 chat_kick(result.chat_id_, result.sender_user_id_)
  ...
  send(msg.chat_id_, msg.id_, 1, '❕┇لا تستطيع حظر \n🔘┇(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   local hash =  'KENAE:'..bot_id..'banned:'..msg.chat_id_
   if not database:sismember(hash, result.sender_user_id_) then
    tsX000("prore",msg,"☑┇بالتاكيد تم الغاء حظره من البوت")
   else
     database:srem(hash, result.sender_user_id_)
  ...
  send(msg.chat_id_, msg.id_, 1, '☑️┇بالتاكيد تم وضع رابط', 1, 'md') 
...
tsX000(apsi[2],msg,"🚫┇تم كتمه من البوت")
    ...
    local hash =  'KENAE:'..bot_id..'muted:'..msg.chat_id_
    if not database:sismember(hash, result.sender_user_id_) then
	tsX000("prore",msg,"🚫┇بالتاكيد تم الغاء كتمه من البوت")
    else
     database:srem(hash, result.sender_user_id_)
...
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. v .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
  ...
  send(msg.chat_id_, msg.id_, 1, '👁‍🗨 ⫶ بالتاكيد تم مسح الاعظاء ⌁ المقيدين ✓', 1, 'md')
  end  
 ...
 send(msg.chat_id_, msg.id_, 1, "❕┇لا تملك صوره رقم <b>{"..pronumb[2].."}</b> في حسابك", 1, 'html')
  ...
  database:set('KENAE:'..bot_id..'flood:time:'..msg.chat_id_,floodt[2])
    ...
    local welcome = {string.match(text, "^(وضع ترحيب) (.*)$")}
     send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم وضع ترحيب\n📜┇~⪼('..welcome[2]..')', 1, 'md')
    ...
    if wel then
     ...
     send(msg.chat_id_, msg.id_, 1, '✖┇لم يبالتاكيد تم وضع ترحيب للمجموعه\n', 1, 'md')
    end
    end
...
database:del('KENAE:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح المحظورين  من البوت ', 1, 'md')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح قائمه المنشئين', 1, 'md')
  end
  ...
  bot.channel_get_bots(msg.chat_id_,cb)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح جميع البوتات', 1, 'md')
  end
  if txt[2] == 'الادمنيه' and is_owner(msg) then
  database:del('KENAE:'..bot_id..'mods:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح قائمه الادمنيه', 1, 'md')
  end
  if  txt[2] == 'الاعضاء المميزين' and is_owner(msg) then
  database:del('KENAE:'..bot_id..'vipgp:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح قائمه الاعضاء المميزين', 1, 'md')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح قائمه المدراء', 1, 'md')
  end
  if  txt[2] == 'القوانين' then
  database:del('KENAE:'..bot_id..'rules'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح القوانين المحفوظه', 1, 'md')
  end
  if txt[2] == 'الرابط' then
  database:del('KENAE:'..bot_id..'group:link'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح الرابط المحفوظ', 1, 'md')
  end
  if txt[2] == 'قائمه المنع' then
  database:del('KENAE:'..bot_id..'filters:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح قائمه المنع', 1, 'md')
  end
  if  txt[2] == 'المكتومين' then
  database:del('KENAE:'..bot_id..'muted:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتاكيد تم مسح قائمه المكتومين', 1, 'md')
  end
  end
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
  ...
  sendContact(msg.chat_id_, msg.id_, 0, 1, nil, nmkeko, text , "", bot_id)
	...
	tsX000(apmd[2],msg,'☑┇بالتاكيد تم رفعه مطور')
  end
 ...
 redis:srem('KENAE:'..bot_id..'kekore'..msg.chat_id_..'', text)
  ...
  redis:del('KENAE:'..bot_id..'sudoo'..v..'', 'no')
    ...
    send(msg.chat_id_, msg.id_, 1, "☑┇بالتاكيد تم مسح مطورين البوت", 1, 'md')
    end
  ...
  redis:set('KENAE:'..bot_id..'keko'..v..''..msg.chat_id_..'', " ")
    ...
    send(msg.chat_id_, msg.id_, 1, "• `بالتاكيد تم مسح ردود المدير` 🗑", 1, 'md')
    end
  ...
  redis:set('KENAE:'..bot_id..'keko'..v..'', " ")
    ...
    send(msg.chat_id_, msg.id_, 1, "☑┇بالتاكيد تم مسح ردود المطور", 1, 'md')
    end
  ...
  text = "❕┇لا يوجد ردود للمدير"
    ...
    database:set('KENAE:'..bot_id..'rules'..msg.chat_id_, txt[2])
     send(msg.chat_id_, msg.id_, 1, "✔┇بالتاكيد تم وضع القوانين للمجموعه", 1, 'md')
    end
    ...
    changetitle(msg.chat_id_, txt[2])
     send(msg.chat_id_, msg.id_, 1, '✔┇بالتاكيد تم تحديث اسم المجموعه الى \n'..txt[2], 1, 'md')
  end
...
if  (text and text == 'تفعيل ردود البوت') and is_owner(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇ بالتاكيد تم مسح مجموعه المطور', 1, 'md')
