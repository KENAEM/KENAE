...
database:set("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  local tsX_o = database:get("lock_new:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الاشعارات")
  else
  ...
  local tsX_o = database:get("lock_tag:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح التاك")
  else
  ...
  local tsX_o = database:get("lock_sarha:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الشارحه")
  else
  ...
  local tsX_o = database:get("lock_lllll:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح التكرار")
  else
  ...
  local tsX_o = database:get("lock_edit:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح التعديل")
  else
  ...
  local tsX_o = database:get("lock_gif:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح المتحركه")
  else
  ...
  local tsX_o = database:get("lock_files:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الملفات")
  else
  ...
  local tsX_o = database:get("lock_mark:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الماركدون")
  else
  ...
  local tsX_o = database:get("lock_photo:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الصور")
  else
  ...
  local tsX_o = database:get("lock_stecker:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الملصقات")
  else
  ...
  local tsX_o = database:get("lock_video:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الفيديو")
  else
  ...
  local tsX_o = database:get("lock_inline:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الانلاين")
  else
  ...
  local tsX_o = database:get("lock_chat:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الدردشه")
  else
  ...
  local tsX_o = database:get("lock_fwd:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح التوجيه")
  else
  ...
  local tsX_o = database:get("lock_pin:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح التثبيت")
  else
  ...
  local tsX_o = database:get("lock_audeo:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الاغاني")
  else
  ...
  local tsX_o = database:get("lock_voice:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الصوت")
  else
  ...
  local tsX_o = database:get("lock_botAndBan:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح البوتات بالطرد")
  else
  ...
  local tsX_o = database:get("lock_contact:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الجهات")
  else
  ...
  local tsX_o = database:get("lock_ar:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح العربيه")
  else
  ...
  local tsX_o = database:get("lock_en:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الانكليزيه")
  else
  ...
  local tsX_o = database:get("lock_media:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الميديا")
  else
...
database:del("lock_note:KENAE"..msg.chat_id_..bot_id,"ok")
  ...
  local tsX_o = database:get("lock_username:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح المعرف")
  else
  ...
  local tsX_o = database:get("lock_note:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح بصمه فيديو")
  else
  ...
  local tsX_o = database:get("lock_link:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
  tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح الروابط")
  else
  ...
  local tsX_o = database:get("lock_bot:KENAE"..msg.chat_id_..bot_id)
  if not tsX_o then
   tsX000("lock",msg,"☑┇بالتأكيد بالتأكيد تم فتح البوتات")
  else
