...
local i8_88_add_sudo = redis:get('KENAE:'..bot_id..'sudoo'..msg.sender_user_id_..'')
...
local i8_88_add_sudo = redis:get('KENAE:'..bot_id..'sudoo'..user_id..'')
...
local files_KENAE = database:smembers("files"..bot_id)
local i8_88 = io.popen('cd files_KENAE && ls'):read("*all")
local files_KENAE2 = ''
...
local kt = KENAEee.i8_88_KENAE(data)
if kt == 'end' then
return false
end
end
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
  ...
  redis:set('KENAE:'..bot_id..'texts'..msg.sender_user_id_..'', 'msg')
    return false end
  if text:match("^(.*)$") then
  local i8_882 = redis:get('KENAE:'..bot_id..'texts'..msg.sender_user_id_..'')
  if i8_882 == 'msg' then
  ...
  local ni8_88 = redis:get('KENAE:'..bot_id..'nmi8_88')
  local nai8_88 = redis:get('KENAE:'..bot_id..'nai8_88')
    if text_sudo then
    send(msg.chat_id_, msg.id_, 1, text_sudo, 1, 'md')
    else
    sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (ni8_88 or 9647819831695), (nai8_88 or "KENAE TEAM"), "", bot_id)
  end
   end
    for k,v in pairs(sudo_users) do
  ...
  redis:set('KENAE:'..bot_id..'ni8_88'..msg.sender_user_id_..'', 'msg')
    return false end
  end
  if text:match("^+(.*)$") then
  local i8_88o = redis:get('KENAE:'..bot_id..'sudoo'..text..'')
  local i8_882 = redis:get('KENAE:'..bot_id..'ni8_88'..msg.sender_user_id_..'')
  if i8_882 == 'msg' then
  send(msg.chat_id_, msg.id_, 1, '• `الان يمكنك ارسال الاسم الذي تريده` 🏷', 1, 'md')
  redis:set('KENAE:'..bot_id..'nmi8_88', text)
  redis:set('KENAE:'..bot_id..'ni8_88'..msg.sender_user_id_..'', 'mmsg')
    return false end
  end
  if text:match("^(.*)$") then
  local i8_882 = redis:get('KENAE:'..bot_id..'ni8_88'..msg.sender_user_id_..'')
  ...
  redis:set('KENAE:'..bot_id..'ni8_88'..msg.sender_user_id_..'', 'no')
  redis:set('KENAE:'..bot_id..'nai8_88', text)
  local nmi8_88 = redis:get('KENAE:'..bot_id..'nmi8_88')
  ...
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..''..msg.chat_id_..'', 'msg')
    return false end
  if text:match("^(.*)$") then
  if not database:get('KENAE:'..bot_id..'repowner:mute'..msg.chat_id_) then
  local i8_88 = redis:get('KENAE:'..bot_id..'i8_88'..text..''..msg.chat_id_..'')
  send(msg.chat_id_, msg.id_, 1, i8_88, 1, 'md')
  end
  local i8_881 = redis:get('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..''..msg.chat_id_..'')
  if i8_881 == 'msg' then
  send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل الرد الذي تريد اضافته', 1, 'md')
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..''..msg.chat_id_..'', 're')
  ...
  redis:sadd('KENAE:'..bot_id..'repowner'..msg.sender_user_id_..''..msg.chat_id_..'', text)
    return false end
  if i8_881 == 're' then
  local i8_882 = redis:get('KENAE:'..bot_id..'msg'..msg.sender_user_id_..''..msg.chat_id_..'')
  redis:set('KENAE:'..bot_id..'i8_88'..i8_882..''..msg.chat_id_..'', text)
  redis:sadd('KENAE:'..bot_id..'i8_88re'..msg.chat_id_..'', i8_882)
  send(msg.chat_id_, msg.id_, 1, "☑┇تم حفظ الرد", 1, 'md')
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
  end
  end
    if text:match("^حذف رد$") and is_owner(msg) then
  send(msg.chat_id_, msg.id_, 1, '📥┇ارسل الكلمه التي تريد حذفها', 1, 'md')
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..''..msg.chat_id_..'', 'nomsg')
    return false end
  if text:match("^(.*)$") then
  local i8_881 = redis:get('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..''..msg.chat_id_..'')
  ...
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
  redis:set('KENAE:'..bot_id..'i8_88'..text..''..msg.chat_id_..'', " ")
 redis:srem('KENAE:'..bot_id..'i8_88re'..msg.chat_id_..'', text)
   end
  end
  ...
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..'', 'msg')
    return false end
  if text:match("^(.*)$") then
  if not database:get('KENAE:'..bot_id..'repsudo:mute'..msg.chat_id_) then
  local i8_88 = redis:get('KENAE:'..bot_id..'i8_88'..text..'')
  send(msg.chat_id_, msg.id_, 1, i8_88, 1, 'md')
  end
  local i8_881 = redis:get('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..'')
  if i8_881 == 'msg' then
  send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل الرد الذي تريد اضافته', 1, 'md')
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..'', 're')
  redis:set('KENAE:'..bot_id..'msg'..msg.sender_user_id_..'', text)
    return false end
  if i8_881 == 're' then
  local i8_882 = redis:get('KENAE:'..bot_id..'msg'..msg.sender_user_id_..'')
  redis:set('KENAE:'..bot_id..'i8_88'..i8_882..'', text)
  redis:sadd('KENAE:'..bot_id..'i8_88resudo', i8_882)
  send(msg.chat_id_, msg.id_, 1, "☑┇تم حفظ الرد", 1, 'md')
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..'', 'no')
  end
  end

  if text:match("^حذف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
  send(msg.chat_id_, msg.id_, 1, '📥┇ارسل الكلمه التي تريد حذفها' , 1, 'md')
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..'', 'nomsg')
    return false end
  if text:match("^(.*)$") then
  local i8_881 = redis:get('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..'')
  if i8_881 == 'nomsg' then
  send(msg.chat_id_, msg.id_, 1, '☑┇تم حذف الرد', 1, 'md')
  redis:set('KENAE:'..bot_id..'i8_881'..msg.sender_user_id_..'', 'no')
   redis:set('KENAE:'..bot_id..'i8_88'..text..'', " ")
   redis:srem('KENAE:'..bot_id..'i8_88resudo', text)
   end
  end
  ...
  redis:del('KENAE:'..bot_id..'sudoo'..v..'', 'no')
    ...
    local list = redis:smembers('KENAE:'..bot_id..'i8_88re'..msg.chat_id_..'')
    for k,v in pairs(list) do
  redis:del('KENAE:'..bot_id..'i8_88re'..msg.chat_id_..'', text)
  redis:set('KENAE:'..bot_id..'i8_88'..v..''..msg.chat_id_..'', " ")
  end
    ...
    local list = redis:smembers('KENAE:'..bot_id..'i8_88resudo')
    for k,v in pairs(list) do
  redis:del('KENAE:'..bot_id..'i8_88resudo', text)
  redis:set('KENAE:'..bot_id..'i8_88'..v..'', " ")
  end
...
i8_883 = math.random(#i8_88_text)
  ...
  local KENAE_new_text = KENAE_new_text:gsub('#username',(i8_88_info or 'لا يوجد'))
  ...
  redis:set('KENAE:'..bot_id..'hhh'..msg.sender_user_id_..'', 'msg')
    return false end
  if text:match("^(.*)$") then
  local i8_882 = redis:get('KENAE:'..bot_id..'hhh'..msg.sender_user_id_..'')
  if i8_882 == 'msg' then
  send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
local photo_i8_88 = download_to_file('https://api.telegram.org/file/bot'..token..'/'..i8_886.result.file_path, 'files_KENAE/'..msg.content_.document_.file_name_)
