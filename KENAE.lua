...
tsX000("prore",msg,"☑┇بالتأكيد بالتأكيد تم رفع منشئ في البوت")
else
...
return false end
  ...
  if database:sismember(hash, result.sender_user_id_) then
  tsX000("prore",msg,'☑┇بالتأكيد بالتأكيد تم رفعه ادمن')
  else
  database:sadd(hash, result.sender_user_id_)
  ...
  if database:sismember(hash, result.sender_user_id_) then
tsX000("prore",msg,"☑┇بالتأكيد بالتأكيد تم رفعه عضو مميز") 
 else
  database:sadd(hash, result.sender_user_id_)
...
tsX000(apsi[2],msg,"🚫┇تم كتمه من البوت")
  ...
  send(msg.chat_id_, msg.id_, 1, '✖┇لا تستطيع طرد \n🔘┇(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
    ...
    if database:sismember(hash, result.sender_user_id_) then
	tsX000("prore",msg,"☑┇بالتأكيد بالتأكيد تم رفع مدير في البوت")
    else
     database:sadd(hash, result.sender_user_id_)
...
database:del('KENAE:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
  ...
  text = '☑┇بالتأكيد تم مسحقائمه العام'
  ...
  text = '☑┇ بالتأكيد تم مسحالمكتومين عام'
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحالمحظورين  من البوت ', 1, 'md')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحقائمه المنشئين', 1, 'md')
  end
  ...
  bot.channel_get_bots(msg.chat_id_,cb)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحجميع البوتات', 1, 'md')
  end
  if txt[2] == 'الادمنيه' and is_owner(msg) then
  database:del('KENAE:'..bot_id..'mods:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحقائمه الادمنيه', 1, 'md')
  end
  if  txt[2] == 'الاعضاء المميزين' and is_owner(msg) then
  database:del('KENAE:'..bot_id..'vipgp:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحقائمه الاعضاء المميزين', 1, 'md')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحقائمه المدراء', 1, 'md')
  end
  if  txt[2] == 'القوانين' then
  database:del('KENAE:'..bot_id..'rules'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحالقوانين المحفوظه', 1, 'md')
  end
  if txt[2] == 'الرابط' then
  database:del('KENAE:'..bot_id..'group:link'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحالرابط المحفوظ', 1, 'md')
  end
  if txt[2] == 'قائمه المنع' then
  database:del('KENAE:'..bot_id..'filters:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحقائمه المنع', 1, 'md')
  end
  if  txt[2] == 'المكتومين' then
  database:del('KENAE:'..bot_id..'muted:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم مسحقائمه المكتومين', 1, 'md')
  end
  end
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
  ...
  local nakeko = redis:get('KENAE:'..bot_id..'nakeko')
    ...
    sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkeko or 9647707641864), (nakeko or "KENAE TEAM"), "", bot_id)
  end
   end
    for k,v in pairs(sudo_users) do
  ...
  sendContact(msg.chat_id_, msg.id_, 0, 1, nil, nmkeko, text , "", bot_id)
	...
	tsX000("prore",msg,'☑┇بالتأكيد بالتأكيد تم رفعه مطور')
  else
 ...
 redis:srem('KENAE:'..bot_id..'kekore'..msg.chat_id_..'', text)
  ...
  redis:del('KENAE:'..bot_id..'sudoo'..v..'', 'no')
    ...
    send(msg.chat_id_, msg.id_, 1, "☑┇بالتأكيد تم مسحمطورين البوت", 1, 'md')
    end
  ...
  redis:set('KENAE:'..bot_id..'keko'..v..''..msg.chat_id_..'', " ")
    ...
    send(msg.chat_id_, msg.id_, 1, "• `بالتأكيد تم مسحردود المدير` 🗑", 1, 'md')
    end
  ...
  redis:set('KENAE:'..bot_id..'keko'..v..'', " ")
    ...
    send(msg.chat_id_, msg.id_, 1, "☑┇بالتأكيد تم مسحردود المطور", 1, 'md')
    end
  ...
  https.request('https://api.telegram.org/bot'..token..'/deleteChatPhoto?chat_id='..msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '🗑┇بالتأكيد تم مسحالصوره', 1, 'md')
  end
...
if (text and text == 'تفعيل جلب صوره') and is_owner(msg) then
  if not database:get('KENAE:'..bot_id..'get:photo'..msg.chat_id_) then
    ...
    send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد تم تفعيل جلب صوره', 1, 'md')
  ...
  if not database:sismember('KENAE:'..bot_id..'pro:groups',msg.chat_id_) then
    send(msg.chat_id_, msg.id_, 1, '☑┇بالتأكيد بالتأكيد تم حذف المجموعه من الوضع المدفوع', 1, 'md')
  else
  ...
  send(msg.chat_id_, msg.id_, 1, '☑┇ بالتأكيد تم مسحمجموعه المطور', 1, 'md')
