...
local ph = pronumb[2] - 1
  ...
  database:set('KENAE:'..bot_id..'flood:time:'..msg.chat_id_,floodt[2])
    ...
    if text:match("^تعطيل الترحيب$") and is_mod(msg) then
     send(msg.chat_id_, msg.id_, 1, '☑️┇تم تعطيل الترحيب في المجموعه', 1, 'md')
    ...
    if wel then
     ...
     send(msg.chat_id_, msg.id_, 1, '✖️┇لم يتم وضع ترحيب للمجموعه\n', 1, 'md')
    end
    end
  ...
  database:hset('KENAE:'..bot_id..'filters:'..msg.chat_id_, name, 'filtered')
          send(msg.chat_id_, msg.id_, 1, "☑️┇تم اضافتها لقائمه المنع\n🔘┇{"..name.."}", 1, 'md')
    end
  ...
  database:hdel('KENAE:'..bot_id..'filters:'..msg.chat_id_, rws[2])
          send(msg.chat_id_, msg.id_, 1, "☑️┇تم حذفها من لقائمه المنع\n🔘┇{"..rws[2].."}", 1, 'md')
    end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم نشر الرساله في {'..gps..'} مجموعه ', 1, 'md')
    end
...
database:del('KENAE:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
  ...
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح المحظورين  من البوت ', 1, 'md')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح قائمه المنشئين', 1, 'md')
  end
  ...
  bot.channel_get_bots(msg.chat_id_,cb)
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح جميع البوتات', 1, 'md')
  end
  if txt[2] == 'الادمنيه' and is_owner(msg) then
  database:del('KENAE:'..bot_id..'mods:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح قائمه الادمنيه', 1, 'md')
  end
  if  txt[2] == 'الاعضاء المميزين' and is_owner(msg) then
  database:del('KENAE:'..bot_id..'vipgp:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح قائمه الاعضاء المميزين', 1, 'md')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح قائمه المدراء', 1, 'md')
  end
  if  txt[2] == 'القوانين' then
  database:del('KENAE:'..bot_id..'rules'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح القوانين المحفوظه', 1, 'md')
  end
  if txt[2] == 'الرابط' then
  database:del('KENAE:'..bot_id..'group:link'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح الرابط المحفوظ', 1, 'md')
  end
  if txt[2] == 'قائمه المنع' then
  database:del('KENAE:'..bot_id..'filters:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح قائمه المنع', 1, 'md')
  end
  if  txt[2] == 'المكتومين' then
  database:del('KENAE:'..bot_id..'muted:'..msg.chat_id_)
  send(msg.chat_id_, msg.id_, 1, '☑️┇تم مسح قائمه المكتومين', 1, 'md')
  end
  end
  ...
  text = '☑️┇تم تنظيف قائمه المحظورين في المجموعه '
  send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
  end
  ...
  text = '☑️┇تم اضافه قائمه المحظورين للمجموعه'
  send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
  end
  bot.channel_get_kicked(msg.chat_id_,cb)
  end
