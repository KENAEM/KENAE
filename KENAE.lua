...
send(msg.chat_id_, msg.id_, 1,  '✖⎮ بالتأكيد  تم المسح بنجاح', 1, 'md')
 ...
 if text ==("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)") then   
...
database:del('KENAE:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
 ...
 if text ==("^(عدد السحكات)$") or text:match("^(سحكاتي)$") then
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
 ...
 if text ==("^[Dd][Ee][Vv]$")or text:match("^مطور بوت$") or text:match("^مطورين$") or text:match("^مبرمج البوت$") or text:match("^مطور$") or text:match("^المطور$") and msg.reply_to_message_id_ == 0 then
...
if (text and text == 'تفعيل جلب صوره') and is_owner(msg) then
 ...
 if text ==("^معلومات (.*)$") then
  ...
  if  (text and text == 'تفعيل التثبيت') and is_owner(msg) then
   ...
   if text ==("^الغاء تثبيت$") and is_mod(msg) and not is_owner(msg) or text:match("^الغاء التثبيت") and is_mod(msg) and not is_owner(msg) then
     if not database:get('KENAE:'..bot_id..'pin:mute'..msg.chat_id_) then
   ...
   if text ==("^الغاء تثبيت$") and is_owner(msg) or text:match("^الغاء التثبيت") and is_owner(msg) then
     unpinmsg(msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم الغاء تثبيت الرساله', 1, 'md')
     end
...
➖➖➖➖➖➖➖➖
 ...
 if text ==("^اصدار$") or text:match("^الاصدار$") or text:match("^السورس$") or text:match("^سورس$") then
  local text = [[
...
➖➖➖➖➖➖➖➖
 ...
 if text ==("^اريد رابط حذف$") or text:match("^رابط حذف$") or text:match("^رابط الحذف$") or text:match("^الرابط حذف$") or text:match("^اريد رابط الحذف$") then
  local text =  [[
  🗑⎮رابط حذف التلي ، ⬇
