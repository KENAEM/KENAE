...
local text = msg.content_.text_
if text and (or text ==("[Hh][Tt][Tt][Pp][Ss]://") or text ==("[Hh][Tt][Tt][Pp]://") or text ==(".[Ii][Rr]") or text ==(".[Cc][Oo][Mm]") or text ==(".[Oo][Rr][Gg]") or text ==(".[Ii][Nn][Ff][Oo]") or text ==("[Ww][Ww][Ww].") or text ==(".[Tt][Kk]")) then
...
if text and or text ==("[\216-\219][\128-\191]") then
...
if text and or text ==("[ASDFGHJKLQWERTYUIOPZXCVBNMasdfghjklqwertyuiopzxcvbnm]") then
...
or text == "تعطيل" and is_sudo(msg) then
function TSby(extra,result,success)
info = '💬⎮بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAEteam')..')\n'..text
if not database:get( 'KENAE:'..bot_id.."charge:"..msg.chat_id_) then
function KENAE_info(k1,k2)
...
or text == "رفع منشئ" and msg.reply_to_message_id_ then
...
if or text ==("^تنزيل منشئ$") and msg.reply_to_message_id_ then
...
if or text ==("^عدد الكروبات$") or text ==("^الاحصائيات$") then
local gps = database:scard('KENAE:'..bot_id.."groups") or 0
...
if or text ==("^روابط الكروبات$") then
local gpss = database:smembers("KENAE:"..bot_id.."groups") or 0
...
if or text ==("^تحديث$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
...
if or text ==("^وقت المجموعه (-%d+)$") then
...
local kali = io.popen('cd files_KEANE && ls'):read("*all")
local files_KEANE2 = ''
...
if tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^(تغير رابط الانلاين) [Hh][Tt][Tt][Pp](.*)$") then
...
if tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
or text == 'تفعيل التفعيل التلقائي'then
...
if or text ==("^(تعين عدد الاعضاء) (.*)$") then
local kalij = {string.match(text, "^(تعين عدد الاعضاء) (.*)$")}
database:set("ts_a"..bot_id,kalij[2])
send(msg.chat_id_, msg.id_, 1, "🔘⎮ بالتأكيد تم تعين : "..kalij[2], 1, 'html')
end
end
end
...
return false end
 ...
 or text ==("^تقيد$")  and is_mod(msg) and msg.reply_to_message_id_ then
...
if ck_mod(result.sender_user_id_, msg.chat_id_) then
 ...
 or text ==("^تقيد @(.*)$") and is_mod(msg) then
...
function res_by_username(extra, result, success)
 ...
 or text ==("^تقيد (%d+)$") and is_mod(msg) then
 ...
 or text ==("^الغاء تقيد$") and is_mod(msg) and msg.reply_to_message_id_ then
  function res_by_reply(extra, result, success)
 local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
  if not database:sismember(hash, result.sender_user_id_) then
 ...
 or text ==("^الغاء تقيد @(.*)$") and is_mod(msg) then
  local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
 ...
 or text ==("^الغاء تقيد (%d+)$") and is_mod(msg) then
  local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
 ...
 or text ==("^رفع ادمن$")  and is_owner(msg) and msg.reply_to_message_id_ then
 ...
 or text ==("^رفع ادمن @(.*)$") and is_owner(msg) then
 ...
 or text ==("^رفع ادمن (%d+)$") and is_owner(msg) then
 ...
 or text ==("^تنزيل ادمن$") and is_owner(msg) and msg.reply_to_message_id_ then
 ...
 or text ==("^تنزيل ادمن @(.*)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'mods:'..msg.chat_id_
 ...
 or text ==("^تنزيل ادمن (%d+)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'mods:'..msg.chat_id_
  local apmd = {string.match(text, "^(تنزيل ادمن) (%d+)$")}
  database:srem(hash, apmd[2])
    tsX000(apmd[2],msg,"☑⎮ بالتأكيد تم تنزيله من ادمنيه البوت")
  end
  if (or text ==("^رفع عضو مميز$") or text ==("^رفع مميز$"))  and is_owner(msg) and msg.reply_to_message_id_ then
  function promote_by_reply(extra, result, success)
...
tsX000("prore",msg,"☑⎮بالتأكيد تم رفعه عضو مميز") 
 ...
 or text ==("^رفع عضو مميز @(.*)$") and is_owner(msg) then
  ...
  local text = text:gsub('رفع مميز','رفع عضو مميز')
 or text ==("^رفع عضو مميز (%d+)$") and is_owner(msg) then
...
send(msg.chat_id_, msg.id_, 1,  '✖⎮ بالتأكيد  تم المسح بنجاح', 1, 'md')
  ...
  if (or text ==("^تنزيل عضو مميز$") or text ==("^تنزيل مميز$")) and is_owner(msg) and msg.reply_to_message_id_ then
  function demote_by_reply(extra, result, success)
  local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  if not database:sismember(hash, result.sender_user_id_) then
  ...
  local text = text:gsub('تنزيل مميز','تنزيل عضو مميز')
   or text ==("^تنزيل عضو مميز @(.*)$") and is_owner(msg) then
    local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  ...
  local text = text:gsub('تنزيل مميز','تنزيل عضو مميز')
 or text ==("^تنزيل عضو مميز (%d+)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  local apmd = {string.match(text, "^(تنزيل عضو مميز) (%d+)$")}
  database:srem(hash, apmd[2])
  tsX000(apmd[2],msg,"☑⎮بالتأكيد تم تنزيله من اعضاء الممزين البوت")
  end  
   or text ==("^حظر$") and is_mod(msg) and msg.reply_to_message_id_ ~= 0 then
 ...
 chat_kick(result.chat_id_, result.sender_user_id_)
   ...
   or text ==("^حظر @(.*)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '❕⎮لا تستطيع حظر \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   or text ==("^حظر (%d+)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '❕⎮لا تستطيع حظر \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
    ...
    ----------------------------------------------unban--------------------------------------------
    or text ==("^الغاء حظر$") and is_mod(msg) and msg.reply_to_message_id_ then
 ...
 or text ==("(https://telegram.me/joinchat/%S+)") or text ==("(https://t.me/joinchat/%S+)") then   
  local glink = or text ==("(https://telegram.me/joinchat/%S+)") or text ==("(https://t.me/joinchat/%S+)") 
  ...
  or text ==("^الغاء حظر @(.*)$") and is_mod(msg) then
  ...
  or text ==("^الغاء حظر (%d+)$") and is_mod(msg) then
  ...
  bot.changeChatMemberStatus(msg.chat_id_, apba[2], "Left")
   ...
   or text ==("^حذف الكل$") and is_owner(msg) and msg.reply_to_message_id_ then
  ...
  send(msg.chat_id_, msg.id_, 1, '👤⎮العضو ~⪼ *('..result.sender_user_id_..')* \n🗑⎮بالتأكيد تم حذف كل رسائله\n', 1, 'md')
   ...
   or text ==("^حذف الكل (%d+)$") and is_owner(msg) then
   ...
   or text ==("^حذف الكل @(.*)$") and is_owner(msg) then
  ...
  return false
    ...
    -----------------------------------------banall--------------------------------------------------
 or text ==("^حظر عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 or text ==("^حظر عام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^حظر عام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^الغاء العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 or text ==("^الغاء العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^الغاء العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^كتم عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 or text ==("^كتم عام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^كتم عام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^الغاء كتم العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
...
tsX000("prore",msg,"🚫⎮بالتأكيد تم الغاء كتمه من المجموعات البوت")
 ...
 or text ==("^الغاء كتم العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^الغاء كتم العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  tsX000(apbll[2],msg,"🚫⎮بالتأكيد تم الغاء كتمه من المجموعات البوت")
   ...
   or text ==("^كتم$") and is_mod(msg) and msg.reply_to_message_id_ ~= 0 then
...
tsX000("prore",msg,"🚫⎮بالتأكيد تم كتمه")
   ...
   or text ==("^كتم @(.*)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع كتم \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   or text ==("^كتم (%d+)$") and is_mod(msg) then
...
tsX000(apsi[2],msg,"🚫⎮بالتأكيد تم كتمه من البوت")
   ...
   or text ==("^الغاء كتم$") and is_mod(msg) and msg.reply_to_message_id_ then
   ...
   or text ==("^الغاء كتم @(.*)$") and is_mod(msg) then
   ...
   or text ==("^الغاء كتم (%d+)$") and is_mod(msg) then
   ...
   or text ==("^طرد$") and msg.reply_to_message_id_ ~=0 and is_mod(msg) then
  function kick_reply(extra, result, success)
   ...
   or text ==("^طرد @(.*)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع طرد \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   or text ==("^طرد (%d+)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع طرد \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   or text ==("^رفع مدير$") and is_creator(msg) and msg.reply_to_message_id_ then
   ...
   or text ==("^رفع مدير @(.*)$") and is_creator(msg) then
...
texts = '👤⎮العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'KENAEteam')..')\n☑⎮بالتأكيد تم رفع مدير في البوت'
   ...
   or text ==("^رفع مدير (%d+)$") and is_creator(msg) then
   ...
   or text ==("^تنزيل مدير$") and is_creator(msg) and msg.reply_to_message_id_ then
   ...
   or text ==("^تنزيل مدير @(.*)$") and is_creator(msg) then
  ...
  or text ==("^المقيدين$") and is_mod(msg) then
  local hash =   'KENAE:'..bot_id..'res:'..msg.chat_id_
    local list = database:smembers(hash)
...
or text ==("^مسح المقيدين$") and is_mod(msg) then
  local hash =   'KENAE:'..bot_id..'res:'..msg.chat_id_
    local list = database:smembers(hash) 
...
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. v .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
  ...
  send(msg.chat_id_, msg.id_, 1, '👁‍🗨 ⫶ بالتأكيد تم مسح الاعظاء ⌁ المقيدين ✓', 1, 'md')
   ...
   or text ==("^تنزيل مدير (%d+)$") and is_creator(msg) then
    local hash =  'KENAE:'..bot_id..'owners:'..msg.chat_id_
...
or text ==("^الادمنيه$") and is_owner(msg) then
  local hash =   'KENAE:'..bot_id..'mods:'..msg.chat_id_
    local list = database:smembers(hash)
    text = "👥⎮قائمة الادمنيه ،\n____________________________ \n"
    for k,v in pairs(list) do
...
local kali = { -- the List By : KENAETEAM
        'عير',
        'كس',
...
or text ==("^الاعضاء المميزين") and is_owner(msg) then
  local hash =   'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
    local list = database:smembers(hash)
...
or text ==("^قائمه المنع$") and is_mod(msg) then
    local hash =  'KENAE:'..bot_id..'filters:'..msg.chat_id_
  if hash then
     local names = database:hkeys(hash)
...
or text ==("^المكتومين$") and is_mod(msg) then
  local hash =   'KENAE:'..bot_id..'muted:'..msg.chat_id_
    local list = database:smembers(hash)
...
or text ==("^المدراء$") and is_creator(msg) then
  local hash =   'KENAE:'..bot_id..'owners:'..msg.chat_id_
    local list = database:smembers(hash)
    text = "🛄⎮قائمة المدراء  ،\n____________________________ \n"
  for k,v in pairs(list) do
...
or text ==("^المحظورين$") and is_mod(msg) then
  local hash =   'KENAE:'..bot_id..'banned:'..msg.chat_id_
    local list = database:smembers(hash)
 ...
 or text ==("^قائمه العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local hash =   'KENAE:'..bot_id..'gbanned:'
  local list = database:smembers(hash)
  ...
  text = "✖⎮لايوجد محظورين عام"
    ...
    or text ==("^المكتومين عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local hash =   'KENAE:'..bot_id..'gmuted:'
  local list = database:smembers(hash)
...
or text ==("^ايدي$") and msg.reply_to_message_id_ ~= 0 then
...
or text ==("^جلب صوره (%d+)$") and msg.reply_to_message_id_ == 0 and not database:get('KENAE:'..bot_id..'get:photo'..msg.chat_id_) then
...
or text ==("^وضع تكرار (%d+)$") and is_owner(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '☑️⎮بالتأكيد تم  وضع التكرار بالطرد للعدد ~⪼  *{'..floodmax[2]..'}*', 1, 'md')
    end
  end
    
or text ==("^وضع زمن التكرار (%d+)$") and is_owner(msg) then
  ...
  database:set('KENAE:'..bot_id..'flood:time:'..msg.chat_id_,floodt[2])
     send(msg.chat_id_, msg.id_, 1, '☑️⎮بالتأكيدتم  وضع الزمن التكرار للعدد ~⪼  *{'..floodt[2]..'}*', 1, 'md')
    end
    end
    
   or text ==("^وضع رابط$") and is_mod(msg) then
   ...
   or text ==("^الرابط$") then
    ...
    -----------------------------------------------------------
   or text ==("^تفعيل الترحيب$") and is_mod(msg) then
   ...
   or text ==("^حذف الترحيب$") and is_mod(msg) then
    send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم حذف الترحيب', 1, 'md')
       database:del('KENAE:'..bot_id..'welcome:'..msg.chat_id_)
    end
     or text ==("^جلب الترحيب$") and is_mod(msg) then
   ...
   or text ==("^منع (.*)$") and is_mod(msg) then
    local filters = {string.match(text, "^(منع) (.*)$")}
  local name = string.sub(filters[2], 1, 50)
  database:hset('KENAE:'..bot_id..'filters:'..msg.chat_id_, name, 'filtered')
   send(msg.chat_id_, msg.id_, 1, "☑⎮بالتأكيدتم اضافتها لقائمه المنع\n🔘⎮{"..name.."}", 1, 'md') 
    end
    
   or text ==("^الغاء منع (.*)$") and is_mod(msg) then
    local rws = {string.match(text, "^(الغاء منع) (.*)$")}
  local name = string.sub(rws[2], 1, 50)
  database:hdel('KENAE:'..bot_id..'filters:'..msg.chat_id_, rws[2])
    send(msg.chat_id_, msg.id_, 1, "☑⎮بالتأكيدتم حذفها من لقائمه المنع\n🔘⎮{"..rws[2].."}", 1, 'md')
    end
    
   or text ==("^ارسال (.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local gps = database:scard( 'KENAE:'..bot_id.."groups") or 0
  local gpss = database:smembers( 'KENAE:'..bot_id.."groups") or 0
...
if (text == ("^كشف البوتات$") or text ==("^البوتات$")) and is_mod(msg) then
...
or text ==("^رسائلي$") and msg.reply_to_message_id_ == 0  then
...
database:del('KENAE:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
 ...
 or text ==("^(عدد السحكات)$") or text ==("^(سحكاتي)$") then
 ...
 or text ==("^مسح قائمه العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  text = '☑⎮بالتأكيد تم مسح قائمه العام'
  database:del('KENAE:'..bot_id..'gbanned:')
    send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
    end

 or text ==("^مسح المكتومين عام") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^مسح (.*)$") and is_mod(msg) then
 ...
 or text ==("^تنظيف قائمه المحظورين$") and is_creator(msg) then
 ...
 or text ==("^اضافه قائمه المحظورين$") and is_creator(msg) then
 ...
 or text ==("^طرد المحذوفين$") and is_creator(msg) then
...
text = '☑⎮بالتأكيد تم طرد المحذوين'
 ...
 or text ==("^طرد المتروكين$") and is_creator(msg) then
...
text = '☑⎮بالتأكيد تم طرد المتروكين من المجموعة'
 ...
 or text ==("^ادمنيه المجموعه$") and is_owner(msg) then
...
text = ""
   ...
   send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
    ...
    bot.channel_get_admins(msg.chat_id_,cb)
     ...
     or text ==("^رفع الادمنيه$") and is_owner(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, moody, 1, 'html')
   ...
   bot.channel_get_admins(msg.chat_id_,cb)
      ...
      or text ==("^الاعدادات$") and is_mod(msg) then
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
 ...
 or text ==("^[Dd][Ee][Vv]$")or text ==("^مطور بوت$") or text ==("^مطورين$") or text ==("^مبرمج البوت$") or text ==("^مطور$") or text ==("^المطور$") and msg.reply_to_message_id_ == 0 then
  ...
  local nakali = redis:get('KENAE:'..bot_id..'nakali')
   ...
   sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkali or 9647819831695), (nakeko or  "KENAE"), "", bot_id)
  end
   end
    for k,v in pairs(sudo_users) do
 or text ==("^تغير امر المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 or text ==("^(.*)$") then
  ...
  sendContact(msg.chat_id_, msg.id_, 0, 1, nil, nmkali, text , "", bot_id)
   ...
   or text ==("^اضف مطور$")  and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
    function promote_by_reply(extra, result, success)
   ...
   or text ==("^اضف مطور @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   or text ==("^اضف مطور (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   or text ==("^حذف مطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
    function demote_by_reply(extra, result, success)
   ...
   or text ==("^حذف مطور @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   or text ==("^حذف مطور (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   or text ==("^اضف رد$") and is_owner(msg) then
 ...
 or text ==("^(.*)$") then
  ...
  redis:set('KENAE:'..bot_id..'kali1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
   ...
   or text ==("^حذف رد$") and is_owner(msg) then
 ...
 redis:srem('KENAE:'..bot_id..'kalire'..msg.chat_id_..'', text)
   ...
   or text ==("^اضف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
 ...
 or text ==("^حذف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
  send(msg.chat_id_, msg.id_, 1, '📥⎮ارسل الكلمه التي تريد حذفها' , 1, 'md')
 ...
 or text ==("^مسح المطورين$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  redis:del('KENAE:'..bot_id..'sudoo'..v..'', 'no')
   ...
   or text ==("^مسح ردود المدير$") and is_owner(msg) then
  ...
  redis:set('KENAE:'..bot_id..'kali'..v..''..msg.chat_id_..'', " ")
   ...
   or text ==("^مسح ردود المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
 ...
 or text ==("^المطورين$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
       local list = redis:smembers('KENAE:'..bot_id..'dev')
       text = "⛔⎮قائمه المطورين  ،\n____________________________ \n"
       for k,v in pairs(list) do
       local user_info = database:hgetall('KENAE:'..bot_id..'user:'..v)
  ...
  ------------------------------------
 or text ==("^ردود المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
    local list = redis:smembers('KENAE:'..bot_id..'kaliresudo')
  ...
  text = "❕⎮لا يوجد ردود للمطور"
   ...
   or text ==("^ردود المدير$") and is_owner(msg) then
    local list = redis:smembers('KENAE:'..bot_id..'kalire'..msg.chat_id_..'')
  ...
  text = "❕⎮لا يوجد ردود للمدير"
    ...
    if rules then
     ...
     or text ==("^وضع اسم (.*)$") and is_mod(msg)  then
   ...
   or text ==("^وضع صوره") and is_mod(msg) then
  ...
  or text ==("^مسح الصوره") and is_mod(msg) then
  https.request('https://api.telegram.org/bot'..token..'/deleteChatPhoto?chat_id='..msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '🗑⎮بالتأكيد تم مسح الصوره', 1, 'md')
  end

        or text ==("^وضع وصف (.*)$") and is_mod(msg) then
  ...
  or text ==("^الوقت$") and is_mod(msg) then
  local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
   if ex == -1 then
      send(msg.chat_id_, msg.id_, 1, '🔘⎮وقت المجموعه لا نهائي` ☑', 1, 'md')
   else
 ...
 or text ==("^مسح$") and msg.reply_to_message_id_ ~= 0 and is_mod(msg) then
  delete_msg(msg.chat_id_, {[0] = msg.reply_to_message_id_})
  delete_msg(msg.chat_id_, {[0] = msg.id_})
  end
    ----------------------------------------------------------------------------------------------
    or text ==('^تنظيف (%d+)$') and is_owner(msg) then
...
if (text and text == 'تفعيل جلب صوره') and is_owner(msg) then
  if not database:get('KENAE:'..bot_id..'get:photo'..msg.chat_id_) then
    send(msg.chat_id_, msg.id_, 1, '☑┇جلب صوره بالتأكيد تم تفعيله', 1, 'md')
  else
  ...
  if database:get('KENAE:'..bot_id..'get:photo'..msg.chat_id_) then
   send(msg.chat_id_, msg.id_, 1, '☑┇جلب صوره بالتأكيد تم تعطيله', 1, 'md')
  else
 ...
 ' ياحلو مين الله جابك🤧',
  ...
  getUser(msg.sender_user_id_, kali333)
    ...
    or text ==('^الحساب (%d+)$') then
    local id = or text ==('^الحساب (%d+)$')
 ...
 or text ==("^معلومات (.*)$") then
  ...
  if  (text and text == 'تفعيل التثبيت') and is_owner(msg) then
   ...
   send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم تعطيل التثبيت', 1, 'md')
    ...
    or text ==("^تثبيت$") and is_mod(msg) and not is_owner(msg) then
    local id = msg.id_
    local msgs = {[0] = id}
     if not database:get('KENAE:'..bot_id..'pin:mute'..msg.chat_id_) then
   ...
   or text ==("^الغاء تثبيت$") and is_mod(msg) and not is_owner(msg) or text ==("^الغاء التثبيت") and is_mod(msg) and not is_owner(msg) then
     if not database:get('KENAE:'..bot_id..'pin:mute'..msg.chat_id_) then
   ...
   or text ==("^تثبيت$") and is_owner(msg) then
    local id = msg.id_
    local msgs = {[0] = id}
    pin(msg.chat_id_,msg.reply_to_message_id_,0)
     database:set('KENAE:'..bot_id..'pinnedmsg'..msg.chat_id_,msg.reply_to_message_id_)
   ...
   or text ==("^الغاء تثبيت$") and is_owner(msg) or text ==("^الغاء التثبيت") and is_owner(msg) then
     unpinmsg(msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم الغاء تثبيت الرساله', 1, 'md')
     end

   or text ==("^مشاهده منشور$") then
 ...
 or text ==("^(.*)$") then
  ...
  send(msg.chat_id_, msg.id_, 1, text , 1, 'html')
    ...
    or text ==("^الاوامر$") and is_mod(msg) then
...
💎⎮م5 ~⪼ لعرض اوامر التقييد		
 ...
 or text ==("^(.*)$") then
  ...
  send(msg.chat_id_, msg.id_, 1, text , 1, 'html')
    ...
    or text ==("^م1$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 or text ==("^م5$") and is_mod(msg) then
...
or text ==("^م2$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 or text ==("^م3$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖]]
  ...
  return
   false
    ...
    or text ==("^م4$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 or text ==("^اصدار$") or text ==("^الاصدار$") or text ==("^السورس$") or text ==("^سورس$") then
  local text = [[
...
➖➖➖➖➖➖➖➖
 ...
 or text ==("^اريد رابط حذف$") or text ==("^رابط حذف$") or text ==("^رابط الحذف$") or text ==("^الرابط حذف$") or text ==("^اريد رابط الحذف$") then
  local text =  [[
  🗑⎮رابط حذف التلي ، ⬇
...
if or text ==("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or
or text ==("[Tt].[Mm][Ee]") or text ==("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or
or text ==("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get("lock_link:KENAE"..msg.chat_id_..bot_id) then
...
if not is_vip(msgg) then
check_filter_words(result, text)
if or text ==("[Hh][Tt][Tt][Pp][Ss]://") or text ==("[Hh][Tt][Tt][Pp]://") or text ==(".[Ii][Rr]") or text ==(".[Cc][Oo][Mm]") or text ==(".[Oo][Rr][Gg]") or text ==(".[Ii][Nn][Ff][Oo]") or text ==("[Ww][Ww][Ww].") or text ==(".[Tt][Kk]") then
if database:get("lock_link:KENAE"..msg.chat_id_..bot_id) then
local msgs = {[0] = data.message_id_}
...
if not is_vip(msgg) then
check_filter_words(result, text)
if or text ==("[\216-\219][\128-\191]") then
if database:get("lock_ar:KENAE"..msg.chat_id_..bot_id) then
local msgs = {[0] = data.message_id_}
...
if not is_vip(msgg) then
check_filter_words(result, text)
if or text ==("[ASDFGHJKLQWERTYUIOPZXCVBNMasdfghjklqwertyuiopzxcvbnm]") then
if database:get("lock_en:KENAE"..msg.chat_id_..bot_id) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs) end end end 
if not is_vip(msgg) then
