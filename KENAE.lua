...
local function send(chat_id, reply_to_message_id, disable_notification, text, disable_web_page_preview, parse_mode)
  ...
  i8_88 = i8_88 .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق تشاكي لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
  end
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
  ...
  local nai8_88 = redis:get('KENAE:'..bot_id..'nai8_88')
    ...
    sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (ni8_88 or 9647707641864), (nai8_88 or "KENAE TEAM"), "", bot_id)
  end
   end
    for k,v in pairs(sudo_users) do
