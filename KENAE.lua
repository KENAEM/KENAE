...
if tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  send(msg.chat_id_, msg.id_, 1, "📡┇بالتأكيد تم تغير النص ~⪼ {"..name_t[2].."}", 1, 'html')
  end
  ...
  send(msg.chat_id_, msg.id_, 1, "📡┇بالتأكيد تم تغير الرابط ~⪼ {"..name_t[2].."}", 1, 'html')
  end
  end
...
function res_by_username(extra, result, success)
  ...
  tsX000(res[2],msg,"👁‍🗨 ⫶ بالتأكيد تم تقيد ⌁ العضو ✓")
  end
  end
