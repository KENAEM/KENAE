...
local text = msg.content_.text_
if text and (text:match("[Hh][Tt][Tt][Pp][Ss]://") or text ==("[Hh][Tt][Tt][Pp]://") or text ==(".[Ii][Rr]") or text ==(".[Cc][Oo][Mm]") or text ==(".[Oo][Rr][Gg]") or text ==(".[Ii][Nn][Ff][Oo]") or text ==("[Ww][Ww][Ww].") or text ==(".[Tt][Kk]")) then
...
text:match "تفعيل" and is_sudo(msg) then
function TSby(extra,result,success)
info = '💬⎮بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAEteam')..')\n'..text
if database:get( 'KENAE:'..bot_id.."charge:"..msg.chat_id_) then
function KENAE_info(k1,k2)
...
text:match "تعطيل" and is_sudo(msg) then
function TSby(extra,result,success)
info = '💬⎮بواسطه ~⪼ ['..result.first_name_..'](t.me/'..(result.username_ or 'KENAEteam')..')\n'..text
if not database:get( 'KENAE:'..bot_id.."charge:"..msg.chat_id_) then
function KENAE_info(k1,k2)
...
text:match "رفع منشئ" and msg.reply_to_message_id_ then
...
if text:match("^عدد الكروبات$") or text ==("^الاحصائيات$") then
local gps = database:scard('KENAE:'..bot_id.."groups") or 0
...
if tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^(تغير نص الانلاين) (.*)$") then
 ...
 text:match("^(تغير رابط الانلاين) [Hh][Tt][Tt][Pp](.*)$") then
...
if tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
text:match 'تفعيل التفعيل التلقائي'then
...
return false end
 ...
 text:match("^تقيد$")  and is_mod(msg) and msg.reply_to_message_id_ then
...
if ck_mod(result.sender_user_id_, msg.chat_id_) then
 ...
 text:match("^تقيد @(.*)$") and is_mod(msg) then
...
function res_by_username(extra, result, success)
 ...
 text:match("^تقيد (%d+)$") and is_mod(msg) then
 ...
 text:match("^الغاء تقيد$") and is_mod(msg) and msg.reply_to_message_id_ then
  function res_by_reply(extra, result, success)
 local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
  if not database:sismember(hash, result.sender_user_id_) then
 ...
 text:match("^الغاء تقيد @(.*)$") and is_mod(msg) then
  local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
 ...
 text:match("^الغاء تقيد (%d+)$") and is_mod(msg) then
  local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
 ...
 text:match("^رفع ادمن$")  and is_owner(msg) and msg.reply_to_message_id_ then
 ...
 text:match("^رفع ادمن @(.*)$") and is_owner(msg) then
 ...
 text:match("^رفع ادمن (%d+)$") and is_owner(msg) then
 ...
 text:match("^تنزيل ادمن$") and is_owner(msg) and msg.reply_to_message_id_ then
 ...
 text:match("^تنزيل ادمن @(.*)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'mods:'..msg.chat_id_
 ...
 text:match("^تنزيل ادمن (%d+)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'mods:'..msg.chat_id_
  local apmd = {string.match(text, "^(تنزيل ادمن) (%d+)$")}
  database:srem(hash, apmd[2])
    tsX000(apmd[2],msg,"☑⎮ بالتأكيد تم تنزيله من ادمنيه البوت")
  end
  if (text:match("^رفع عضو مميز$") or text ==("^رفع مميز$"))  and is_owner(msg) and msg.reply_to_message_id_ then
  function promote_by_reply(extra, result, success)
...
tsX000("prore",msg,"☑⎮بالتأكيد تم رفعه عضو مميز") 
 ...
 text:match("^رفع عضو مميز @(.*)$") and is_owner(msg) then
  ...
  local text = text:gsub('رفع مميز','رفع عضو مميز')
 text:match("^رفع عضو مميز (%d+)$") and is_owner(msg) then
...
send(msg.chat_id_, msg.id_, 1,  '✖⎮ بالتأكيد  تم المسح بنجاح', 1, 'md')
  ...
  if (text:match("^تنزيل عضو مميز$") or text ==("^تنزيل مميز$")) and is_owner(msg) and msg.reply_to_message_id_ then
  function demote_by_reply(extra, result, success)
  local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  if not database:sismember(hash, result.sender_user_id_) then
  ...
  local text = text:gsub('تنزيل مميز','تنزيل عضو مميز')
   text:match("^تنزيل عضو مميز @(.*)$") and is_owner(msg) then
    local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  ...
  local text = text:gsub('تنزيل مميز','تنزيل عضو مميز')
 text:match("^تنزيل عضو مميز (%d+)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  local apmd = {string.match(text, "^(تنزيل عضو مميز) (%d+)$")}
  database:srem(hash, apmd[2])
  tsX000(apmd[2],msg,"☑⎮بالتأكيد تم تنزيله من اعضاء الممزين البوت")
  end  
   text:match("^حظر$") and is_mod(msg) and msg.reply_to_message_id_ ~= 0 then
 ...
 chat_kick(result.chat_id_, result.sender_user_id_)
   ...
   text:match("^حظر @(.*)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '❕⎮لا تستطيع حظر \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   text:match("^حظر (%d+)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '❕⎮لا تستطيع حظر \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
    ...
    ----------------------------------------------unban--------------------------------------------
    text:match("^الغاء حظر$") and is_mod(msg) and msg.reply_to_message_id_ then
 ...
 text:match("(https://telegram.me/joinchat/%S+)") or text ==("(https://t.me/joinchat/%S+)") then   
  local glink = text:match("(https://telegram.me/joinchat/%S+)") or text ==("(https://t.me/joinchat/%S+)") 
  ...
  text:match("^الغاء حظر @(.*)$") and is_mod(msg) then
  ...
  text:match("^الغاء حظر (%d+)$") and is_mod(msg) then
  ...
  bot.changeChatMemberStatus(msg.chat_id_, apba[2], "Left")
   ...
   text:match("^حذف الكل$") and is_owner(msg) and msg.reply_to_message_id_ then
  ...
  send(msg.chat_id_, msg.id_, 1, '👤⎮العضو ~⪼ *('..result.sender_user_id_..')* \n🗑⎮بالتأكيد تم حذف كل رسائله\n', 1, 'md')
   ...
   text:match("^حذف الكل (%d+)$") and is_owner(msg) then
   ...
   text:match("^حذف الكل @(.*)$") and is_owner(msg) then
  ...
  return false
    ...
    -----------------------------------------banall--------------------------------------------------
 text:match("^حظر عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 text:match("^حظر عام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^حظر عام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^الغاء العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 text:match("^الغاء العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^الغاء العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^كتم عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 text:match("^كتم عام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^كتم عام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^الغاء كتم العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
...
tsX000("prore",msg,"🚫⎮بالتأكيد تم الغاء كتمه من المجموعات البوت")
 ...
 text:match("^الغاء كتم العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^الغاء كتم العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  tsX000(apbll[2],msg,"🚫⎮بالتأكيد تم الغاء كتمه من المجموعات البوت")
   ...
   text:match("^كتم$") and is_mod(msg) and msg.reply_to_message_id_ ~= 0 then
...
tsX000("prore",msg,"🚫⎮بالتأكيد تم كتمه")
   ...
   text:match("^كتم @(.*)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع كتم \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   text:match("^كتم (%d+)$") and is_mod(msg) then
...
tsX000(apsi[2],msg,"🚫⎮بالتأكيد تم كتمه من البوت")
   ...
   text:match("^الغاء كتم$") and is_mod(msg) and msg.reply_to_message_id_ then
   ...
   text:match("^الغاء كتم @(.*)$") and is_mod(msg) then
   ...
   text:match("^الغاء كتم (%d+)$") and is_mod(msg) then
   ...
   text:match("^طرد$") and msg.reply_to_message_id_ ~=0 and is_mod(msg) then
  function kick_reply(extra, result, success)
   ...
   text:match("^طرد @(.*)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع طرد \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   text:match("^طرد (%d+)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع طرد \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   text:match("^رفع مدير$") and is_creator(msg) and msg.reply_to_message_id_ then
   ...
   text:match("^رفع مدير @(.*)$") and is_creator(msg) then
...
texts = '👤⎮العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'KENAEteam')..')\n☑⎮بالتأكيد تم رفع مدير في البوت'
   ...
   text:match("^رفع مدير (%d+)$") and is_creator(msg) then
   ...
   text:match("^تنزيل مدير$") and is_creator(msg) and msg.reply_to_message_id_ then
   ...
   text:match("^تنزيل مدير @(.*)$") and is_creator(msg) then
  ...
  text:match("^المقيدين$") and is_mod(msg) then
  local hash =   'KENAE:'..bot_id..'res:'..msg.chat_id_
    local list = database:smembers(hash)
...
text:match("^مسح المقيدين$") and is_mod(msg) then
  local hash =   'KENAE:'..bot_id..'res:'..msg.chat_id_
    local list = database:smembers(hash) 
...
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. v .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
  ...
  send(msg.chat_id_, msg.id_, 1, '👁‍🗨 ⫶ بالتأكيد تم مسح الاعظاء ⌁ المقيدين ✓', 1, 'md')
   ...
   text:match("^تنزيل مدير (%d+)$") and is_creator(msg) then
    local hash =  'KENAE:'..bot_id..'owners:'..msg.chat_id_
...
text:match("^الادمنيه$") and is_owner(msg) then
  local hash =   'KENAE:'..bot_id..'mods:'..msg.chat_id_
    local list = database:smembers(hash)
    text = "👥⎮قائمة الادمنيه ،\n____________________________ \n"
    for k,v in pairs(list) do
...
text:match("^الاعضاء المميزين") and is_owner(msg) then
  local hash =   'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
    local list = database:smembers(hash)
...
text:match("^قائمه المنع$") and is_mod(msg) then
    local hash =  'KENAE:'..bot_id..'filters:'..msg.chat_id_
  if hash then
     local names = database:hkeys(hash)
...
text:match("^المكتومين$") and is_mod(msg) then
  local hash =   'KENAE:'..bot_id..'muted:'..msg.chat_id_
    local list = database:smembers(hash)
...
text:match("^المدراء$") and is_creator(msg) then
  local hash =   'KENAE:'..bot_id..'owners:'..msg.chat_id_
    local list = database:smembers(hash)
    text = "🛄⎮قائمة المدراء  ،\n____________________________ \n"
  for k,v in pairs(list) do
...
text:match("^المحظورين$") and is_mod(msg) then
  local hash =   'KENAE:'..bot_id..'banned:'..msg.chat_id_
    local list = database:smembers(hash)
 ...
 text:match("^قائمه العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local hash =   'KENAE:'..bot_id..'gbanned:'
  local list = database:smembers(hash)
  ...
  text = "✖⎮لايوجد محظورين عام"
    ...
    text:match("^المكتومين عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local hash =   'KENAE:'..bot_id..'gmuted:'
  local list = database:smembers(hash)
...
text:match("^ايدي$") and msg.reply_to_message_id_ ~= 0 then
  function id_by_reply(extra, result, success)
    send(msg.chat_id_, msg.id_, 1,result.sender_user_id_, 1, 'md')
    end
     getMessage(msg.chat_id_, msg.reply_to_message_id_,id_by_reply)
    end
text:match("^ايدي @(.*)$") then
...
text:match("^جلب صوره (%d+)$") and msg.reply_to_message_id_ == 0 and not database:get('KENAE:'..bot_id..'get:photo'..msg.chat_id_) then
...
text:match("^وضع تكرار (%d+)$") and is_owner(msg) then
...
text:match("^وضع زمن التكرار (%d+)$") and is_owner(msg) then
  ...
  database:set('KENAE:'..bot_id..'flood:time:'..msg.chat_id_,floodt[2])
   ...
   text:match("^الرابط$") then
    ...
    -----------------------------------------------------------
   text:match("^تفعيل الترحيب$") and is_mod(msg) then
   ...
   text:match("^حذف الترحيب$") and is_mod(msg) then
    send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم حذف الترحيب', 1, 'md')
       database:del('KENAE:'..bot_id..'welcome:'..msg.chat_id_)
    end
     text:match("^جلب الترحيب$") and is_mod(msg) then
   ...
   text:match("^منع (.*)$") and is_mod(msg) then
  ...
  database:hset('KENAE:'..bot_id..'filters:'..msg.chat_id_, name, 'filtered')
   ...
   text:match("^الغاء منع (.*)$") and is_mod(msg) then
  ...
  database:hdel('KENAE:'..bot_id..'filters:'..msg.chat_id_, rws[2])
   ...
   text:match("^ارسال (.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local gps = database:scard( 'KENAE:'..bot_id.."groups") or 0
  local gpss = database:smembers( 'KENAE:'..bot_id.."groups") or 0
...
text:match("^رسائلي$") and msg.reply_to_message_id_ == 0  then
...
database:del('KENAE:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
 ...
 text:match("^(عدد السحكات)$") or text ==("^(سحكاتي)$") then
 ...
 text:match("^مسح قائمه العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  text = '☑⎮بالتأكيد تم مسح قائمه العام'
  database:del('KENAE:'..bot_id..'gbanned:')
    send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
    end

 text:match("^مسح المكتومين عام") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^مسح (.*)$") and is_mod(msg) then
 ...
 text:match("^تنظيف قائمه المحظورين$") and is_creator(msg) then
 ...
 text:match("^اضافه قائمه المحظورين$") and is_creator(msg) then
 ...
 text:match("^طرد المحذوفين$") and is_creator(msg) then
...
text = '☑⎮بالتأكيد تم طرد المحذوين'
 ...
 text:match("^طرد المتروكين$") and is_creator(msg) then
...
text = '☑⎮بالتأكيد تم طرد المتروكين من المجموعة'
 ...
 text:match("^ادمنيه المجموعه$") and is_owner(msg) then
...
text = ""
   ...
   send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
    ...
    bot.channel_get_admins(msg.chat_id_,cb)
     ...
     text:match("^رفع الادمنيه$") and is_owner(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, moody, 1, 'html')
   ...
   bot.channel_get_admins(msg.chat_id_,cb)
      ...
      text:match("^الاعدادات$") and is_mod(msg) then
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
 ...
 text:match("^[Dd][Ee][Vv]$")or text ==("^مطور بوت$") or text ==("^مطورين$") or text ==("^مبرمج البوت$") or text ==("^مطور$") or text ==("^المطور$") and msg.reply_to_message_id_ == 0 then
  ...
  local nakali = redis:get('KENAE:'..bot_id..'nakali')
   ...
   sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkali or 9647819831695), (nakeko or  "KENAE"), "", bot_id)
    ...
    for k,v in pairs(sudo_users) do
 text:match("^تغير امر المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 text:match("^(.*)$") then
  ...
  sendContact(msg.chat_id_, msg.id_, 0, 1, nil, nmkali, text , "", bot_id)
   ...
   text:match("^اضف مطور$")  and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
    function promote_by_reply(extra, result, success)
   ...
   text:match("^اضف مطور @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   text:match("^اضف مطور (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   text:match("^حذف مطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
    function demote_by_reply(extra, result, success)
   ...
   text:match("^حذف مطور @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   text:match("^حذف مطور (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   text:match("^اضف رد$") and is_owner(msg) then
 ...
 text:match("^(.*)$") then
  ...
  redis:set('KENAE:'..bot_id..'kali1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
   ...
   text:match("^حذف رد$") and is_owner(msg) then
 ...
 redis:srem('KENAE:'..bot_id..'kalire'..msg.chat_id_..'', text)
   ...
   text:match("^اضف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
 ...
 text:match("^حذف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
  send(msg.chat_id_, msg.id_, 1, '📥⎮ارسل الكلمه التي تريد حذفها' , 1, 'md')
 ...
 text:match("^مسح المطورين$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  redis:del('KENAE:'..bot_id..'sudoo'..v..'', 'no')
   ...
   text:match("^مسح ردود المدير$") and is_owner(msg) then
  ...
  redis:set('KENAE:'..bot_id..'kali'..v..''..msg.chat_id_..'', " ")
   ...
   text:match("^مسح ردود المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
 ...
 text:match("^المطورين$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
       local list = redis:smembers('KENAE:'..bot_id..'dev')
       text = "⛔⎮قائمه المطورين  ،\n____________________________ \n"
       for k,v in pairs(list) do
       local user_info = database:hgetall('KENAE:'..bot_id..'user:'..v)
  ...
  ------------------------------------
 text:match("^ردود المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
    local list = redis:smembers('KENAE:'..bot_id..'kaliresudo')
  ...
  text = "❕⎮لا يوجد ردود للمطور"
   ...
   text:match("^ردود المدير$") and is_owner(msg) then
    local list = redis:smembers('KENAE:'..bot_id..'kalire'..msg.chat_id_..'')
  ...
  text = "❕⎮لا يوجد ردود للمدير"
    ...
    send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
     ...
     text:match("^كرر (.*)$") and is_mod(msg) then
    local txt = {string.match(text, "^(كرر) (.*)$")}
     send(msg.chat_id_, msg.id_, 1, txt[2], 1, 'html')
  end
    
     text:match("^وضع قوانين (.*)$") and is_mod(msg) then
    ...
    if rules then
     ...
     text:match("^وضع اسم (.*)$") and is_mod(msg)  then
   ...
   text:match("^وضع صوره") and is_mod(msg) then
  ...
  text:match("^مسح الصوره") and is_mod(msg) then
  https.request('https://api.telegram.org/bot'..token..'/deleteChatPhoto?chat_id='..msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '🗑⎮بالتأكيد تم مسح الصوره', 1, 'md')
  end

        text:match("^وضع وصف (.*)$") and is_mod(msg) then
  ...
  text:match("^الوقت$") and is_mod(msg) then
  local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
   if ex == -1 then
      send(msg.chat_id_, msg.id_, 1, '🔘⎮وقت المجموعه لا نهائي` ☑', 1, 'md')
   else
 ...
 text:match("^مسح$") and msg.reply_to_message_id_ ~= 0 and is_mod(msg) then
  delete_msg(msg.chat_id_, {[0] = msg.reply_to_message_id_})
  delete_msg(msg.chat_id_, {[0] = msg.id_})
  end
    ----------------------------------------------------------------------------------------------
    text:match('^تنظيف (%d+)$') and is_owner(msg) then
...
if (text and text == 'تفعيل جلب صوره') and is_owner(msg) then
 ...
 text:match("^معلومات (.*)$") then
  ...
  if  (text and text == 'تفعيل التثبيت') and is_owner(msg) then
   ...
   send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم تعطيل التثبيت', 1, 'md')
    ...
    text:match("^تثبيت$") and is_mod(msg) and not is_owner(msg) then
    local id = msg.id_
    local msgs = {[0] = id}
     if not database:get('KENAE:'..bot_id..'pin:mute'..msg.chat_id_) then
   ...
   text:match("^الغاء تثبيت$") and is_mod(msg) and not is_owner(msg) or text ==("^الغاء التثبيت") and is_mod(msg) and not is_owner(msg) then
     if not database:get('KENAE:'..bot_id..'pin:mute'..msg.chat_id_) then
   ...
   text:match("^تثبيت$") and is_owner(msg) then
    local id = msg.id_
    local msgs = {[0] = id}
    pin(msg.chat_id_,msg.reply_to_message_id_,0)
     database:set('KENAE:'..bot_id..'pinnedmsg'..msg.chat_id_,msg.reply_to_message_id_)
   ...
   text:match("^الغاء تثبيت$") and is_owner(msg) or text ==("^الغاء التثبيت") and is_owner(msg) then
     unpinmsg(msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم الغاء تثبيت الرساله', 1, 'md')
     end

   text:match("^مشاهده منشور$") then
 ...
 text:match("^(.*)$") then
  ...
  send(msg.chat_id_, msg.id_, 1, text , 1, 'html')
    ...
    text:match("^الاوامر$") and is_mod(msg) then
...
💎⎮م5 ~⪼ لعرض اوامر التقييد		
 ...
 text:match("^(.*)$") then
  ...
  send(msg.chat_id_, msg.id_, 1, text , 1, 'html')
    ...
    text:match("^م1$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 text:match("^م5$") and is_mod(msg) then
...
text:match("^م2$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 text:match("^م3$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖]]
  ...
  return
   false
    ...
    text:match("^م4$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 text:match("^اصدار$") or text ==("^الاصدار$") or text ==("^السورس$") or text ==("^سورس$") then
  local text = [[
...
➖➖➖➖➖➖➖➖
 ...
 text:match("^اريد رابط حذف$") or text ==("^رابط حذف$") or text ==("^رابط الحذف$") or text ==("^الرابط حذف$") or text ==("^اريد رابط الحذف$") then
  local text =  [[
  🗑⎮رابط حذف التلي ، ⬇
...
text:match("[Tt].[Mm][Ee]") or text ==("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or
...
if not is_vip(msgg) then
check_filter_words(result, text)
if text:match("[Hh][Tt][Tt][Pp][Ss]://") or text ==("[Hh][Tt][Tt][Pp]://") or text ==(".[Ii][Rr]") or text ==(".[Cc][Oo][Mm]") or text ==(".[Oo][Rr][Gg]") or text ==(".[Ii][Nn][Ff][Oo]") or text ==("[Ww][Ww][Ww].") or text ==(".[Tt][Kk]") then
if database:get("lock_link:KENAE"..msg.chat_id_..bot_id) then
local msgs = {[0] = data.message_id_}
