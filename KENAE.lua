...
local text = msg.content_.text_
if text and (if text ==("[Hh][Tt][Tt][Pp][Ss]://") or if text ==("[Hh][Tt][Tt][Pp]://") or if text ==(".[Ii][Rr]") or if text ==(".[Cc][Oo][Mm]") or if text ==(".[Oo][Rr][Gg]") or if text ==(".[Ii][Nn][Ff][Oo]") or if text ==("[Ww][Ww][Ww].") or if text ==(".[Tt][Kk]")) then
...
if text and if text ==("[\216-\219][\128-\191]") then
...
if text and if text ==("[ASDFGHJKLQWERTYUIOPZXCVBNMasdfghjklqwertyuiopzxcvbnm]") then
...
if if text ==("^تنزيل منشئ$") and msg.reply_to_message_id_ then
...
if if text ==("^عدد الكروبات$") or if text ==("^الاحصائيات$") then
local gps = database:scard('KENAE:'..bot_id.."groups") or 0
...
if if text ==("^روابط الكروبات$") then
local gpss = database:smembers("KENAE:"..bot_id.."groups") or 0
...
if if text ==("^تحديث$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
...
if if text ==("^وقت المجموعه (-%d+)$") then
...
if tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^(تغير رابط الانلاين) [Hh][Tt][Tt][Pp](.*)$") then
...
if if text ==("^(تعين عدد الاعضاء) (.*)$") then
...
if ck_mod(result.sender_user_id_, msg.chat_id_) then
 ...
 if text ==("^تقيد @(.*)$") and is_mod(msg) then
...
function res_by_username(extra, result, success)
 ...
 if text ==("^تقيد (%d+)$") and is_mod(msg) then
 ...
 if text ==("^الغاء تقيد @(.*)$") and is_mod(msg) then
  local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
 ...
 if text ==("^الغاء تقيد (%d+)$") and is_mod(msg) then
  local hash =  'KENAE:'..bot_id..'res:'..msg.chat_id_
 ...
 if text ==("^رفع ادمن$")  and is_owner(msg) and msg.reply_to_message_id_ then
 ...
 if text ==("^رفع ادمن @(.*)$") and is_owner(msg) then
 ...
 if text ==("^رفع ادمن (%d+)$") and is_owner(msg) then
 ...
 if text ==("^تنزيل ادمن$") and is_owner(msg) and msg.reply_to_message_id_ then
 ...
 if text ==("^تنزيل ادمن @(.*)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'mods:'..msg.chat_id_
 ...
 if text ==("^تنزيل ادمن (%d+)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'mods:'..msg.chat_id_
  local apmd = {string.match(text, "^(تنزيل ادمن) (%d+)$")}
  database:srem(hash, apmd[2])
    tsX000(apmd[2],msg,"☑⎮ بالتأكيد تم تنزيله من ادمنيه البوت")
  end
  if (if text ==("^رفع عضو مميز$") or if text ==("^رفع مميز$"))  and is_owner(msg) and msg.reply_to_message_id_ then
  function promote_by_reply(extra, result, success)
...
tsX000("prore",msg,"☑⎮بالتأكيد تم رفعه عضو مميز") 
 ...
 if text ==("^رفع عضو مميز @(.*)$") and is_owner(msg) then
  ...
  local text = text:gsub('رفع مميز','رفع عضو مميز')
 if text ==("^رفع عضو مميز (%d+)$") and is_owner(msg) then
...
send(msg.chat_id_, msg.id_, 1,  '✖⎮ بالتأكيد  تم المسح بنجاح', 1, 'md')
  ...
  if (if text ==("^تنزيل عضو مميز$") or if text ==("^تنزيل مميز$")) and is_owner(msg) and msg.reply_to_message_id_ then
  function demote_by_reply(extra, result, success)
  local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  if not database:sismember(hash, result.sender_user_id_) then
  ...
  local text = text:gsub('تنزيل مميز','تنزيل عضو مميز')
   if text ==("^تنزيل عضو مميز @(.*)$") and is_owner(msg) then
    local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  ...
  local text = text:gsub('تنزيل مميز','تنزيل عضو مميز')
 if text ==("^تنزيل عضو مميز (%d+)$") and is_owner(msg) then
  local hash =  'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
  local apmd = {string.match(text, "^(تنزيل عضو مميز) (%d+)$")}
  database:srem(hash, apmd[2])
  tsX000(apmd[2],msg,"☑⎮بالتأكيد تم تنزيله من اعضاء الممزين البوت")
  end  
   if text ==("^حظر$") and is_mod(msg) and msg.reply_to_message_id_ ~= 0 then
 ...
 chat_kick(result.chat_id_, result.sender_user_id_)
  ...
  send(msg.chat_id_, msg.id_, 1, '❕⎮لا تستطيع حظر \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   if text ==("^حظر (%d+)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '❕⎮لا تستطيع حظر \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
    ...
    ----------------------------------------------unban--------------------------------------------
    if text ==("^الغاء حظر$") and is_mod(msg) and msg.reply_to_message_id_ then
 ...
 if text ==("(https://telegram.me/joinchat/%S+)") or if text ==("(https://t.me/joinchat/%S+)") then   
  local glink = if text ==("(https://telegram.me/joinchat/%S+)") or if text ==("(https://t.me/joinchat/%S+)") 
  ...
  if text ==("^الغاء حظر @(.*)$") and is_mod(msg) then
  ...
  if text ==("^الغاء حظر (%d+)$") and is_mod(msg) then
  ...
  bot.changeChatMemberStatus(msg.chat_id_, apba[2], "Left")
   ...
   if text ==("^حذف الكل$") and is_owner(msg) and msg.reply_to_message_id_ then
  ...
  send(msg.chat_id_, msg.id_, 1, '👤⎮العضو ~⪼ *('..result.sender_user_id_..')* \n🗑⎮بالتأكيد تم حذف كل رسائله\n', 1, 'md')
   ...
   if text ==("^حذف الكل (%d+)$") and is_owner(msg) then
   ...
   if text ==("^حذف الكل @(.*)$") and is_owner(msg) then
  ...
  return false
    ...
    -----------------------------------------banall--------------------------------------------------
 if text ==("^حظر عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 if text ==("^حظر عام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^حظر عام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^الغاء العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 if text ==("^الغاء العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^الغاء العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^كتم عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
 ...
 if text ==("^كتم عام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^كتم عام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^الغاء كتم العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
...
tsX000("prore",msg,"🚫⎮بالتأكيد تم الغاء كتمه من المجموعات البوت")
 ...
 if text ==("^الغاء كتم العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^الغاء كتم العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  tsX000(apbll[2],msg,"🚫⎮بالتأكيد تم الغاء كتمه من المجموعات البوت")
   ...
   if text ==("^كتم$") and is_mod(msg) and msg.reply_to_message_id_ ~= 0 then
...
tsX000("prore",msg,"🚫⎮بالتأكيد تم كتمه")
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع كتم \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   if text ==("^كتم (%d+)$") and is_mod(msg) then
...
tsX000(apsi[2],msg,"🚫⎮بالتأكيد تم كتمه من البوت")
   ...
   if text ==("^الغاء كتم$") and is_mod(msg) and msg.reply_to_message_id_ then
   ...
   if text ==("^الغاء كتم @(.*)$") and is_mod(msg) then
   ...
   if text ==("^الغاء كتم (%d+)$") and is_mod(msg) then
   ...
   if text ==("^طرد$") and msg.reply_to_message_id_ ~=0 and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع طرد \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   if text ==("^طرد (%d+)$") and is_mod(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, '✖⎮لا تستطيع طرد \n🔘⎮(مدراء،ادمنيه،اعضاء مميزين)البوت', 1, 'md')
   ...
   if text ==("^رفع مدير$") and is_creator(msg) and msg.reply_to_message_id_ then
   ...
   if text ==("^رفع مدير @(.*)$") and is_creator(msg) then
...
texts = '👤⎮العضو ~⪼ ['..result.title_..'](t.me/'..(apow[2] or 'KENAEteam')..')\n☑⎮بالتأكيد تم رفع مدير في البوت'
   ...
   if text ==("^رفع مدير (%d+)$") and is_creator(msg) then
   ...
   if text ==("^تنزيل مدير$") and is_creator(msg) and msg.reply_to_message_id_ then
   ...
   if text ==("^تنزيل مدير @(.*)$") and is_creator(msg) then
...
HTTPS.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. v .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
  ...
  send(msg.chat_id_, msg.id_, 1, '👁‍🗨 ⫶ بالتأكيد تم مسح الاعظاء ⌁ المقيدين ✓', 1, 'md')
   ...
   if text ==("^تنزيل مدير (%d+)$") and is_creator(msg) then
    local hash =  'KENAE:'..bot_id..'owners:'..msg.chat_id_
...
if text ==("^الادمنيه$") and is_owner(msg) then
  local hash =   'KENAE:'..bot_id..'mods:'..msg.chat_id_
    local list = database:smembers(hash)
    text = "👥⎮قائمة الادمنيه ،\n____________________________ \n"
    for k,v in pairs(list) do
...
if text ==("^الاعضاء المميزين") and is_owner(msg) then
  local hash =   'KENAE:'..bot_id..'vipgp:'..msg.chat_id_
    local list = database:smembers(hash)
...
if text ==("^المدراء$") and is_creator(msg) then
  local hash =   'KENAE:'..bot_id..'owners:'..msg.chat_id_
    local list = database:smembers(hash)
    text = "🛄⎮قائمة المدراء  ،\n____________________________ \n"
  for k,v in pairs(list) do
...
if text ==("^المحظورين$") and is_mod(msg) then
 ...
 if text ==("^قائمه العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local hash =   'KENAE:'..bot_id..'gbanned:'
  local list = database:smembers(hash)
  ...
  text = "✖⎮لايوجد محظورين عام"
    ...
    if text ==("^المكتومين عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local hash =   'KENAE:'..bot_id..'gmuted:'
  local list = database:smembers(hash)
...
if text ==("^جلب صوره (%d+)$") and msg.reply_to_message_id_ == 0 and not database:get('KENAE:'..bot_id..'get:photo'..msg.chat_id_) then
...
if text ==("^وضع تكرار (%d+)$") and is_owner(msg) then
...
if text ==("^وضع زمن التكرار (%d+)$") and is_owner(msg) then
  ...
  database:set('KENAE:'..bot_id..'flood:time:'..msg.chat_id_,floodt[2])
   ...
   if text ==("^وضع رابط$") and is_mod(msg) then
   ...
   if text ==("^وضع ترحيب (.*)$") and is_mod(msg) then
   ...
   if text ==("^حذف الترحيب$") and is_mod(msg) then
    send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم حذف الترحيب', 1, 'md')
       database:del('KENAE:'..bot_id..'welcome:'..msg.chat_id_)
    end
     if text ==("^جلب الترحيب$") and is_mod(msg) then
   ...
   if text ==("^منع (.*)$") and is_mod(msg) then
  ...
  database:hset('KENAE:'..bot_id..'filters:'..msg.chat_id_, name, 'filtered')
   ...
   if text ==("^الغاء منع (.*)$") and is_mod(msg) then
  ...
  database:hdel('KENAE:'..bot_id..'filters:'..msg.chat_id_, rws[2])
   ...
   if text ==("^ارسال (.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  local gps = database:scard( 'KENAE:'..bot_id.."groups") or 0
  local gpss = database:smembers( 'KENAE:'..bot_id.."groups") or 0
...
if text ==("^رسائلي$") and msg.reply_to_message_id_ == 0  then
...
database:del('KENAE:'..bot_id..'user:add'..msg.chat_id_..':'..msg.sender_user_id_)
 ...
 if text ==("^(عدد السحكات)$") or if text ==("^(سحكاتي)$") then
 ...
 if text ==("^مسح قائمه العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  text = '☑⎮بالتأكيد تم مسح قائمه العام'
  database:del('KENAE:'..bot_id..'gbanned:')
    send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
    end

 if text ==("^مسح المكتومين عام") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^تنظيف قائمه المحظورين$") and is_creator(msg) then
 ...
 if text ==("^اضافه قائمه المحظورين$") and is_creator(msg) then
 ...
 if text ==("^طرد المحذوفين$") and is_creator(msg) then
...
text = '☑⎮بالتأكيد تم طرد المحذوين'
 ...
 if text ==("^طرد المتروكين$") and is_creator(msg) then
...
text = '☑⎮بالتأكيد تم طرد المتروكين من المجموعة'
 ...
 if text ==("^ادمنيه المجموعه$") and is_owner(msg) then
...
text = ""
   ...
   send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
    ...
    bot.channel_get_admins(msg.chat_id_,cb)
     ...
     if text ==("^رفع الادمنيه$") and is_owner(msg) then
  ...
  send(msg.chat_id_, msg.id_, 1, moody, 1, 'html')
   ...
   bot.channel_get_admins(msg.chat_id_,cb)
      ...
      if text ==("^الاعدادات$") and is_mod(msg) then
...
local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
 ...
 if text ==("^[Dd][Ee][Vv]$")or if text ==("^مطور بوت$") or if text ==("^مطورين$") or if text ==("^مبرمج البوت$") or if text ==("^مطور$") or if text ==("^المطور$") and msg.reply_to_message_id_ == 0 then
  ...
  local nakali = redis:get('KENAE:'..bot_id..'nakali')
   ...
   sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkali or 9647819831695), (nakeko or  "KENAE"), "", bot_id)
    ...
    for k,v in pairs(sudo_users) do
 if text ==("^تغير امر المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 if text ==("^(.*)$") then
  ...
  sendContact(msg.chat_id_, msg.id_, 0, 1, nil, nmkali, text , "", bot_id)
   ...
   if text ==("^اضف مطور$")  and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
    function promote_by_reply(extra, result, success)
   ...
   if text ==("^اضف مطور @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   if text ==("^اضف مطور (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   if text ==("^حذف مطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) and msg.reply_to_message_id_ then
    function demote_by_reply(extra, result, success)
   ...
   if text ==("^حذف مطور @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
   ...
   if text ==("^حذف مطور (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
 ...
 redis:srem('KENAE:'..bot_id..'kalire'..msg.chat_id_..'', text)
   ...
   if text ==("^اضف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
 ...
 if text ==("^حذف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
  send(msg.chat_id_, msg.id_, 1, '📥⎮ارسل الكلمه التي تريد حذفها' , 1, 'md')
 ...
 if text ==("^مسح المطورين$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
  ...
  redis:set('KENAE:'..bot_id..'kali'..v..''..msg.chat_id_..'', " ")
   ...
   if text ==("^مسح ردود المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
 ...
 if text ==("^المطورين$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
       local list = redis:smembers('KENAE:'..bot_id..'dev')
       text = "⛔⎮قائمه المطورين  ،\n____________________________ \n"
       for k,v in pairs(list) do
       local user_info = database:hgetall('KENAE:'..bot_id..'user:'..v)
  ...
  ------------------------------------
 if text ==("^ردود المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  then
    local list = redis:smembers('KENAE:'..bot_id..'kaliresudo')
  ...
  text = "❕⎮لا يوجد ردود للمدير"
    ...
    if rules then
     ...
     if text ==("^وضع اسم (.*)$") and is_mod(msg)  then
   ...
   if text ==("^وضع صوره") and is_mod(msg) then
  ...
  if text ==("^مسح الصوره") and is_mod(msg) then
  https.request('https://api.telegram.org/bot'..token..'/deleteChatPhoto?chat_id='..msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '🗑⎮بالتأكيد تم مسح الصوره', 1, 'md')
  end

        if text ==("^وضع وصف (.*)$") and is_mod(msg) then
  ...
  if text ==("^الوقت$") and is_mod(msg) then
  local ex = database:ttl( 'KENAE:'..bot_id.."charge:"..msg.chat_id_)
   if ex == -1 then
      send(msg.chat_id_, msg.id_, 1, '🔘⎮وقت المجموعه لا نهائي` ☑', 1, 'md')
   else
 ...
 if text ==("^مسح$") and msg.reply_to_message_id_ ~= 0 and is_mod(msg) then
  delete_msg(msg.chat_id_, {[0] = msg.reply_to_message_id_})
  delete_msg(msg.chat_id_, {[0] = msg.id_})
  end
    ----------------------------------------------------------------------------------------------
    if text ==('^تنظيف (%d+)$') and is_owner(msg) then
...
if (text and text == 'تفعيل جلب صوره') and is_owner(msg) then
 ...
 if text ==("^معلومات (.*)$") then
  ...
  if  (text and text == 'تفعيل التثبيت') and is_owner(msg) then
   ...
   send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم تعطيل التثبيت', 1, 'md')
    ...
    if text ==("^تثبيت$") and is_mod(msg) and not is_owner(msg) then
    local id = msg.id_
    local msgs = {[0] = id}
     if not database:get('KENAE:'..bot_id..'pin:mute'..msg.chat_id_) then
   ...
   if text ==("^الغاء تثبيت$") and is_mod(msg) and not is_owner(msg) or if text ==("^الغاء التثبيت") and is_mod(msg) and not is_owner(msg) then
     if not database:get('KENAE:'..bot_id..'pin:mute'..msg.chat_id_) then
   ...
   if text ==("^تثبيت$") and is_owner(msg) then
    local id = msg.id_
    local msgs = {[0] = id}
    pin(msg.chat_id_,msg.reply_to_message_id_,0)
     database:set('KENAE:'..bot_id..'pinnedmsg'..msg.chat_id_,msg.reply_to_message_id_)
   ...
   if text ==("^الغاء تثبيت$") and is_owner(msg) or if text ==("^الغاء التثبيت") and is_owner(msg) then
     unpinmsg(msg.chat_id_)
     send(msg.chat_id_, msg.id_, 1, '☑⎮بالتأكيد تم الغاء تثبيت الرساله', 1, 'md')
     end
 ...
 if text ==("^(.*)$") then
  ...
  send(msg.chat_id_, msg.id_, 1, text , 1, 'html')
    ...
    if text ==("^الاوامر$") and is_mod(msg) then
...
💎⎮م5 ~⪼ لعرض اوامر التقييد		
 ...
 if text ==("^(.*)$") then
  ...
  send(msg.chat_id_, msg.id_, 1, text , 1, 'html')
    ...
    if text ==("^م1$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 if text ==("^م5$") and is_mod(msg) then
...
if text ==("^م2$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 if text ==("^م3$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖]]
  ...
  return
   false
    ...
    if text ==("^م4$") and is_mod(msg) then
...
➖➖➖➖➖➖➖➖
 ...
 if text ==("^اصدار$") or if text ==("^الاصدار$") or if text ==("^السورس$") or if text ==("^سورس$") then
  local text = [[
...
➖➖➖➖➖➖➖➖
 ...
 if text ==("^اريد رابط حذف$") or if text ==("^رابط حذف$") or if text ==("^رابط الحذف$") or if text ==("^الرابط حذف$") or if text ==("^اريد رابط الحذف$") then
  local text =  [[
  🗑⎮رابط حذف التلي ، ⬇
...
if if text ==("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or
if text ==("[Tt].[Mm][Ee]") or if text ==("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or
if text ==("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get("lock_link:KENAE"..msg.chat_id_..bot_id) then
...
if not is_vip(msgg) then
check_filter_words(result, text)
if if text ==("[Hh][Tt][Tt][Pp][Ss]://") or if text ==("[Hh][Tt][Tt][Pp]://") or if text ==(".[Ii][Rr]") or if text ==(".[Cc][Oo][Mm]") or if text ==(".[Oo][Rr][Gg]") or if text ==(".[Ii][Nn][Ff][Oo]") or if text ==("[Ww][Ww][Ww].") or if text ==(".[Tt][Kk]") then
if database:get("lock_link:KENAE"..msg.chat_id_..bot_id) then
local msgs = {[0] = data.message_id_}
...
if not is_vip(msgg) then
check_filter_words(result, text)
if if text ==("[\216-\219][\128-\191]") then
if database:get("lock_ar:KENAE"..msg.chat_id_..bot_id) then
local msgs = {[0] = data.message_id_}
...
if not is_vip(msgg) then
check_filter_words(result, text)
if if text ==("[ASDFGHJKLQWERTYUIOPZXCVBNMasdfghjklqwertyuiopzxcvbnm]") then
if database:get("lock_en:KENAE"..msg.chat_id_..bot_id) then
local msgs = {[0] = data.message_id_}
delete_msg(msg.chat_id_,msgs) end end end 
if not is_vip(msgg) then
