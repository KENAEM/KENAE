...
local kali222 = 'https://KENAE.tk/KENAEApi/ch.php?id='..msg.sender_user_id_..''
local ress = https.request(kali222)
if ress then
...
function thsake_info2(k1,k2)
function dl_cb222(t1,t2)
database:set('KENAE:'..bot_id.."group:link"..msg.chat_id_,(t2.invite_link_ or "Error")) 
...
function dl_cb222(t1,t2)
database:set('KENAE:'..bot_id.."group:link"..msg.chat_id_,(t2.invite_link_ or "Error")) 
send(tostring((database:get("KENAE"..bot_id..":sudo:gr") or sudo_add)), 0, 1, "🔘┇قام تعطيل مجموعه \n🎫┇ايدي مطور ~⪼ ("..msg.sender_user_id_..")\n📜┇معرف المطور ~⪼ @"..(result.username_ or "لا يوجد").."\n🌐┇معلومات المجموعه \n\n🎫┇ايدي المجموعه ~⪼ ("..msg.chat_id_..")\nⓂ️┇اسم المجموعه ~⪼ ("..k2.title_..")\n📎┇رابط المجموعه ~⪼ ["..(t2.invite_link_ or "Error").."]" , 1, 'html')
end
tdcli_function ({
ID = "GetChannelFull",
channel_id_ = getChatId(msg.chat_id_).ID
...
local tsX_o = database:get("KENAE:lo:edit:new:"..bot_id..msg.chat_id_)
if tsX_o then
tsX000("lock",msg,"☑┇بالفعل تم قفل تعديل الميديا")
else
tsX000("lock",msg,"☑┇تم قفل تعديل الميديا")
database:set("KENAE:lo:edit:new:"..bot_id..msg.chat_id_,"ok")
end
end
if (text == "قفل الكلايش") then
local tsX_o = database:get("lock_word:KENAE"..msg.chat_id_..bot_id)
if tsX_o then
...
database:del("lock_word:KENAE"..msg.chat_id_..bot_id)
end
end
...
database:del("KENAE:lo:edit:new:"..bot_id..msg.chat_id_)
end
end
...
local text = msg.content_.text_
if text then 
if database:get("lock_word:KENAE"..msg.chat_id_..bot_id) then 
local KENAE_wr = (database:get("KENAE:not:word:"..bot_id..msg.chat_id_) or 100)
if #text >= tonumber(KENAE_wr) then
...
if (not database:get('KENAE:'..bot_id..'bc:groups') or tonumber(sudo_add) == tonumber(msg.sender_user_id_)) then
send(msg.chat_id_, msg.id_, 1, '☑┇ ارسال الان نص او الميديا : (صوره - فديو - متحركه - ملف)', 1, 'md')
database:set("KENAE:set_if_bc_new:"..bot_id..msg.sender_user_id_,"ok")
return "KENAE"
else
...
local KENAE_edis = {string.match(text, "^اضف امر (.*)$")}
send(msg.chat_id_, msg.id_, 1, "☑┇ ارسال الان الامر الجديد", 1, 'md')
database:set("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id,KENAE_edis[1])
...
database:set("KENAE:edit:text:su:new:"..bot_id..msg.chat_id_..database:get("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id),text)
database:set("KENAE:edit:text:su:new2:"..bot_id..msg.chat_id_..text,database:get("tsahke:new:msg:"..msg.chat_id_..msg.sender_user_id_..bot_id))
...
database:del("KENAE:edit:text:su:new2:"..bot_id..msg.chat_id_..database:get("KENAE:edit:text:su:new:"..bot_id..msg.chat_id_..t[1]))
database:del("KENAE:edit:text:su:new:"..bot_id..msg.chat_id_..t[1])
...
database:set("tsahke:set:id:"..bot_id..msg.chat_id_..msg.sender_user_id_,'KENAE')
return "KENAE"
end
...
if not is_creator(msg) and database:get("KENAE:lock:ban_and_kick"..bot_id..msg.chat_id_) then 
...
database:set('KENAE:'..bot_id.."group:link"..msg.chat_id_,glink) 
...
-----------------------------------------------
if (text and text == "ابلاغ" and msg.reply_to_message_id_ ~= 0 and (not database:get("KENAE:mute:deleta:msg:"..bot_id..msg.chat_id_))) then 
b = database:get("KENAE:user:deleteL:msg:"..msg.chat_id_..bot_id..msg.sender_user_id_)
if b and b == os.date("%x") then 
send(msg.chat_id_, msg.id_, 1, "👤┇ لا يمكنك الابلاغ اكثر من مره في اليوم", 1, 'html')
else
database:set("KENAE:user:deleteL:msg:"..msg.chat_id_..bot_id..msg.sender_user_id_,os.date("%x"))
...
database:set("KENAE:mute:deleta:msg:"..bot_id..msg.chat_id_,"KENAEE")
send(msg.chat_id_, msg.id_, 1, "🔓┇تم تعطيل خاصيه الابلاغ", 1, 'html')
end
if (text and text == "تفعيل الابلاغ" and is_creator(msg)) then 
database:del("KENAE:mute:deleta:msg:"..bot_id..msg.chat_id_)
...
local KENAE_098 = 0
if database:get("KENAE:get:mod:"..bot_id..msg.chat_id_) then 
t = database:get("KENAE:get:mod:"..bot_id..msg.chat_id_)
KENAE_098 = tonumber(t2.member_count_) - tonumber(t)
end
send(msg.chat_id_, msg.id_, 1, "🔖┇عدد المجموعه\n👤┇عدد المدراء : "..t2.administrator_count_.."\n👥┇عدد الاعضاء : "..t2.member_count_.." | ("..KENAE_098..")\n🔥┇عدد المطرودين : "..t2.kicked_count_, 1, 'md')
database:set("KENAE:get:mod:"..bot_id..msg.chat_id_,t2.member_count_)   
end
tdcli_function ({
ID = "GetChannelFull",
channel_id_ = getChatId(msg.chat_id_).ID
...
local msgs = database:get('KENAE:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.sender_user_id_) or 0
local edit = database:get('KENAE:'..bot_id..'user:editmsg'..msg.chat_id_..':'..result.sender_user_id_) or 0
local msg2 = msg
msg2.sender_user_id_ = result.sender_user_id_
if is_sudo(msg2) then
KENAE_oop = 'مطور البوت'
elseif is_creator(msg) then
KENAE_oop = 'منشئ الكروب'
elseif (database:get("KENAE:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) and database:get("KENAE:all_if:"..database:get("KENAE:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) ..bot_id..msg.chat_id_)) then 
KENAE_oop = database:get("KENAE:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_)
elseif is_owner(msg2) then
KENAE_oop = 'مدير الكروب'
elseif ck_mod(result.sender_user_id_,msg.chat_id_) then
KENAE_oop = 'ادمن للكروب'
...
if result.id_ then
if not database:get('KENAE:'..bot_id..'id:mute'..msg.chat_id_) then 
local msgs = database:get('KENAE:'..bot_id..'user:msgs'..msg.chat_id_..':'..result.id_) or 0
local edit = database:get('KENAE:'..bot_id..'user:editmsg'..msg.chat_id_..':'..result.id_) or 0
local msg2 = msg
...
elseif is_creator(msg) then
KENAE_oop = 'منشئ الكروب'
elseif (database:get("KENAE:name_user:"..bot_id..msg.chat_id_..result.id_) and database:get("KENAE:all_if:"..database:get("KENAE:name_user:"..bot_id..msg.chat_id_..result.id_) ..bot_id..msg.chat_id_)) then 
KENAE_oop = database:get("KENAE:name_user:"..bot_id..msg.chat_id_..result.id_)
elseif is_owner(msg2) then
KENAE_oop = 'مدير الكروب'
...
database:set("KENAE:gr:not:ads:"..bot_id..msg.chat_id_..os.date("%x"),"ok")
send(msg.chat_id_, msg.id_, 1, '🖲┇ تم تعطيل ضهور الاعلانات لمده يوم \n📊┇ [يمكنك معرفه المزيد حول الاعلانات هنا](https://t.me/KENAEADS)', 1, "md") 
else
...
database:del("KENAE:gr:not:ads:"..bot_id..msg.chat_id_..os.date("%x"))
...
if not database:get("KENAE:mute:link:gr:"..bot_id..msg.chat_id_) then 
function dl_cb222( t1,t2 )
if t2.invite_link_ ~= false then 
send(msg.chat_id_, msg.id_, 1, '📮┇رابط المجموعه\n'..(t2.invite_link_ or "Error"), 1, "html")
elseif (database:get('KENAE:'..bot_id.."group:link"..msg.chat_id_)) then 
send(msg.chat_id_, msg.id_, 1, '📮┇رابط المجموعه\n'..database:get('KENAE:'..bot_id.."group:link"..msg.chat_id_), 1, "html")
else
...
getChannelMembers(msg.chat_id_,"Kicked",0,10000,kaliididi)
end
...
KENAE_0 = {string.match(text, "^(تعين عدد الاحرف) (%d+)$")}
send(msg.chat_id_, msg.id_, 1, '☑┇ تم تعين عدد الاحرف {`'..KENAE_0[2]..'`}', 1, 'md')
database:set("KENAE:not:word:"..bot_id..msg.chat_id_,KENAE_0[2])
end
...
database:set("KENAE:lock:ban_and_kick"..bot_id..msg.chat_id_,"KENAE")
...
database:del("KENAE:lock:ban_and_kick"..bot_id..msg.chat_id_)
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, (nkali or 9647723177600), (nakali or "KENAE TEAM"), "", bot_id)
end
end
for k,v in pairs(sudo_users) do
...
if kali then 
function kali_KENAE_re(t1,t2)
local user_msgs = database:get('KENAE:'..bot_id..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit = database:get('KENAE:'..bot_id..'user:editmsg'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local t = ""
if is_sudo(msg) then
t = 'مطور البوت'
...
local kali = kali:gsub('#username',(t2.username_ or 'لا يوجد')) 
local kali = kali:gsub('#name',(t2.first_name_ or 'لا يوجد'))
local kali = kali:gsub('#id',(msg.sender_user_id_ or 'لا يوجد'))
local kali = kali:gsub('#edit',(edit or 'لا يوجد'))
local kali = kali:gsub('#msgs',(user_msgs or 'لا يوجد'))
local kali = kali:gsub('#stast',(t or 'لا يوجد'))
send(msg.chat_id_, msg.id_, 1, kali, 1, 'md')
end
getUser(msg.sender_user_id_, kali_KENAE_re)
elseif (redis:get('KENAE:'..bot_id..':sticker:'..text..''..msg.chat_id_..'')) then 
tdcli.sendSticker(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':sticker:'..text..''..msg.chat_id_..''))
elseif (redis:get('KENAE:'..bot_id..':voice:'..text..''..msg.chat_id_..'')) then 
tdcli.sendVoice(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':voice:'..text..''..msg.chat_id_..''))
elseif (redis:get('KENAE:'..bot_id..':video:'..text..''..msg.chat_id_..'')) then 
tdcli.sendVideo(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':video:'..text..''..msg.chat_id_..''))
elseif (redis:get('KENAE:'..bot_id..':gif:'..text..''..msg.chat_id_..'')) then 
tdcli.sendDocument(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':gif:'..text..''..msg.chat_id_..''))
elseif (redis:get('KENAE:'..bot_id..':file:'..text..''..msg.chat_id_..'')) then
tdcli.sendDocument(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':file:'..text..''..msg.chat_id_..''))
end
end
...
kali = kali:gsub('#username',(t2.username_ or 'لا يوجد'))
kali = kali:gsub('#name',(t2.first_name_ or 'لا يوجد'))
kali = kali:gsub('#id',(msg.sender_user_id_ or 'لا يوجد'))
kali = kali:gsub('#edit',(edit or 'لا يوجد'))
kali = kali:gsub('#msgs',(user_msgs or 'لا يوجد'))
kali = kali:gsub('#stast',(t or 'لا يوجد'))
send(msg.chat_id_, msg.id_, 1, kali, 1, 'html')
end
getUser(msg.sender_user_id_, kali_KENAE_re)
elseif (redis:get('KENAE:'..bot_id..':sticker:'..text)) then 
tdcli.sendSticker(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':sticker:'..text))
elseif (redis:get('KENAE:'..bot_id..':voice:'..text)) then 
tdcli.sendVoice(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':voice:'..text))
elseif (redis:get('KENAE:'..bot_id..':video:'..text)) then 
tdcli.sendVideo(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':video:'..text))
elseif (redis:get('KENAE:'..bot_id..':gif:'..text)) then 
tdcli.sendDocument(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':gif:'..text))
elseif (redis:get('KENAE:'..bot_id..':file:'..text)) then
tdcli.sendDocument(chat_id, msg.id_, 0, 1, nil, redis:get('KENAE:'..bot_id..':file:'..text))
end  
end
...
redis:del('KENAE:'..bot_id..'kali'..text..''..msg.chat_id_..'')
redis:del('KENAE:'..bot_id..':sticker:'..text..''..msg.chat_id_..'')
redis:del('KENAE:'..bot_id..':voice:'..text..''..msg.chat_id_..'')
redis:del('KENAE:'..bot_id..':video:'..text..''..msg.chat_id_..'')
redis:del('KENAE:'..bot_id..':gif:'..text..''..msg.chat_id_..'')
redis:del('KENAE:'..bot_id..':file:'..text..''..msg.chat_id_..'')
...
for k,v in pairs(list) do
redis:del('KENAE:'..bot_id..'dev')
redis:del('KENAE:'..bot_id..'sudoo'..v)
end
...
redis:del('KENAE:'..bot_id..'kali'..v..''..msg.chat_id_)
redis:del('KENAE:'..bot_id..':sticker:'..v..msg.chat_id_)
redis:del('KENAE:'..bot_id..':voice:'..v..msg.chat_id_)
redis:del('KENAE:'..bot_id..':video:'..v..msg.chat_id_)
redis:del('KENAE:'..bot_id..':gif:'..v..msg.chat_id_)
redis:del('KENAE:'..bot_id..':file:'..v..msg.chat_id_)
redis:del('KENAE:'..bot_id..'kali'..v..msg.chat_id_)
end
...
redis:del('KENAE:'..bot_id..'kali'..v..'')
redis:del('KENAE:'..bot_id..':sticker:'..v)
redis:del('KENAE:'..bot_id..':voice:'..v)
redis:del('KENAE:'..bot_id..':video:'..v)
redis:del('KENAE:'..bot_id..':gif:'..v)
redis:del('KENAE:'..bot_id..':file:'..v)
redis:del('KENAE:'..bot_id..'kali'..v)
end
...
if not database:get('KENAE:'..bot_id..'get:photo'..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, '☑┇جلب صوره بالفعل تم تفعيله', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل جلب صوره', 1, 'md')
database:del('KENAE:'..bot_id..'get:photo'..msg.chat_id_)
end
end
if (text and text == 'تعطيل جلب صوره') and is_owner(msg) then
if database:get('KENAE:'..bot_id..'get:photo'..msg.chat_id_) then
...
database:del("KENAE:all_if:"..text..bot_id..msg.chat_id_)
database:del("tsahke:is_del_if:"..bot_id..msg.chat_id_..msg.sender_user_id_)
end
if (text and text == "اضف صلاحيه" and is_creator(msg)) then 
send(msg.chat_id_, msg.id_, 1, '☑┇ارسال الان اسم الصلاحيه', 1, 'md')
database:set("KENAE:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "KENAE"
end
if text and database:get("KENAE:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_) then 
database:del("KENAE:new:if:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
database:set("KENAE:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_,text)
database:set("KENAE:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "KENAE"
end
if (text and database:get("KENAE:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
if (text == "ادمن" or text == "مدير" or text == "عضو مميز" or text == "لا شيئ") then 
database:del("KENAE:new:if2:"..bot_id..msg.chat_id_..msg.sender_user_id_)
tsha_text = database:get("KENAE:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '☑️┇تم حفض الصلاحيه بنجاح \n⚠️┇الاوامر { رفع/تنزيل '..tsha_text..' }', 1, 'md')
database:set("KENAE:all_if:"..tsha_text..bot_id..msg.chat_id_,text)
database:del("KENAE:new:if:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
else 
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
end
end
...
ts_text = database:get("KENAE:all_if:"..a[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_reply(extra, result, success)
if ts_text == "ادمن" then 
database:sadd('KENAE:'..bot_id..'mods:'..msg.chat_id_, result.sender_user_id_)
elseif ts_text == "عضو مميز" then 
database:sadd('KENAE:'..bot_id..'vipgp:'..msg.chat_id_, result.sender_user_id_)
elseif ts_text == "مدير" then 
database:sadd('KENAE:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_)
end
database:set("KENAE:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_,a[1])
function kali33332(extra,result2,success)
info = '👤┇العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or 'KENAETeam')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
getUser(result.sender_user_id_, kali33332)  
end 
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end 
end
...
ts_text = database:get("KENAE:all_if:"..apmd[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_username(extra, result, success)
if result.id_ then
if ts_text == "ادمن" then 
...
database:set("KENAE:name_user:"..bot_id..msg.chat_id_..result.id_,apmd[1])
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'KENAEteam')..')\n☑┇تم رفعه '..apmd[1]
else
texts = '✖┇خطاء'
end
...
database:sadd('KENAE:'..bot_id..'vipgp:'..msg.chat_id_, apmd[2])
elseif ts_text == "مدير" then 
database:sadd('KENAE:'..bot_id..'owners:'..msg.chat_id_, apmd[2])
end
database:set("KENAE:name_user:"..bot_id..msg.chat_id_..apmd[2],apmd[1])
...
function demote_by_reply(extra, result, success)
if ts_text == "ادمن" then 
database:srem('KENAE:'..bot_id..'mods:'..msg.chat_id_, result.sender_user_id_)
elseif ts_text == "عضو مميز" then 
database:srem('KENAE:'..bot_id..'vipgp:'..msg.chat_id_, result.sender_user_id_)
elseif ts_text == "مدير" then 
database:srem('KENAE:'..bot_id..'owners:'..msg.chat_id_, result.sender_user_id_)
end
database:del("KENAE:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_)
...
if result.id_ then
if ts_text == "ادمن" then 
database:srem('KENAE:'..bot_id..'mods:'..msg.chat_id_, result.id_)
elseif ts_text == "عضو مميز" then 
database:srem('KENAE:'..bot_id..'vipgp:'..msg.chat_id_, result.id_)
elseif ts_text == "مدير" then 
database:srem('KENAE:'..bot_id..'owners:'..msg.chat_id_, result.id_)
end
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'KENAEteam')..')\n☑┇تم تنزيله من '..apmd[1]
database:del("KENAE:name_user:"..bot_id..msg.chat_id_..result.id_)
else
texts = '✖┇خطاء'
end
send(msg.chat_id_, msg.id_, 1, texts, 1, 'md')
...
if ts_text then 
if ts_text == "ادمن" then 
database:srem('KENAE:'..bot_id..'mods:'..msg.chat_id_, apmd[2])
elseif ts_text == "عضو مميز" then 
database:srem('KENAE:'..bot_id..'vipgp:'..msg.chat_id_, apmd[2])
elseif ts_text == "مدير" then 
database:srem('KENAE:'..bot_id..'owners:'..msg.chat_id_, apmd[2])
end
tsX000(apmd[2],msg,"☑┇ تم تنزيله من "..apmd[1])
database:del("KENAE:name_user:"..bot_id..msg.chat_id_..apmd[2])
end
end
end 
...
database:set("KENAE:mute:link:gr:"..bot_id..msg.chat_id_,"ok")
end
if (text and text == "تفعيل الرابط" and is_owner(msg)) then 
send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل امر الروابط', 1, 'md')
database:del("KENAE:mute:link:gr:"..bot_id..msg.chat_id_)
end
...
return false end
if text:match("^(.*)$") then
local kali2 = redis:get('KENAE:'..bot_id..'h33'..msg.sender_user_id_..'')
if kali2 == 'msg' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
local h3 = redis:get('KENAE:'..bot_id..'h3')
local text =  [[
🥇┇ اوامر المدراء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
id_kali = data.message_.content_.photo_.sizes_[0].photo_.persistent_id_
end
if data.message_.content_.photo_.sizes_[1] then
id_kali = data.message_.content_.photo_.sizes_[1].photo_.persistent_id_
end
if data.message_.content_.photo_.sizes_[2] then
id_kali = data.message_.content_.photo_.sizes_[2].photo_.persistent_id_
end	
if data.message_.content_.photo_.sizes_[3] then
id_kali = data.message_.content_.photo_.sizes_[3].photo_.persistent_id_
end
gpss = database:smembers( 'KENAE:'..bot_id.."groups") or 0
for i=1, #gpss do
if not database:sismember('KENAE:'..bot_id..'pro:groups', gpss[i]) then
tdcli.sendPhoto(gpss[i], 0, 0, 1, nil, id_kali,(msg.content_.caption_ or " "))
end					
end
end
gpss = database:smembers( 'KENAE:'..bot_id.."groups") or 0
...
redis:set('KENAE:'..bot_id..':sticker:'..kali2..''..msg.chat_id_..'', data.message_.content_.sticker_.sticker_.persistent_id_)
elseif (data.message_.content_.voice_) then 
redis:set('KENAE:'..bot_id..':voice:'..kali2..''..msg.chat_id_..'', data.message_.content_.voice_.voice_.persistent_id_)
elseif (data.message_.content_.video_) then 
redis:set('KENAE:'..bot_id..':video:'..kali2..''..msg.chat_id_..'', data.message_.content_.video_.video_.persistent_id_)
elseif (data.message_.content_.animation_) then 
redis:set('KENAE:'..bot_id..':gif:'..kali2..''..msg.chat_id_..'', data.message_.content_.animation_.animation_.persistent_id_)
elseif (data.message_.content_.document_) then
redis:set('KENAE:'..bot_id..':file:'..kali2..''..msg.chat_id_..'', data.message_.content_.document_.document_.persistent_id_)
else
end -- end if text 
...
redis:set('KENAE:'..bot_id..':sticker:'..kali2, msg.content_.sticker_.sticker_.persistent_id_)
elseif (msg.content_.voice_) then 
redis:set('KENAE:'..bot_id..':voice:'..kali2, msg.content_.voice_.voice_.persistent_id_)
elseif (msg.content_.video_) then 
redis:set('KENAE:'..bot_id..':video:'..kali2, msg.content_.video_.video_.persistent_id_)
elseif (msg..content_.animation_) then 
redis:set('KENAE:'..bot_id..':gif:'..kali2, data.message_.content_.animation_.animation_.persistent_id_)
elseif (msg.content_.document_) then
redis:set('KENAE:'..bot_id..':file:'..kali2, msg.content_.document_.document_.persistent_id_)
end
